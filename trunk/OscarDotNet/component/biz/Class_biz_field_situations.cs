    ...
    internal string MapRenditionOf(string address)
      ...
      if (map_rendition_of == "100 NORFOLK CY")
        ...
        map_rendition_of = Regex.Replace
          (
          input:map_rendition_of,
          pattern:"(?<prefix> )CO$|(?<prefix> )CO(?<suffix>/)|(?<prefix> )CO(?<suffix> )",
        ...
        map_rendition_of = Regex.Replace
          (
          input:map_rendition_of,
          pattern:"(?<prefix> )HE$|(?<prefix> )HE(?<suffix>/)|(?<prefix> )HE(?<suffix> )",
          replacement:"${prefix}HEATH${suffix}"
          );
        map_rendition_of = Regex.Replace
          (
          input:map_rendition_of,
          pattern:"(?<prefix> )KP$|(?<prefix> )KP(?<suffix>/)|(?<prefix> )KP(?<suffix> )",
        ...
        map_rendition_of = Regex.Replace
          (
          input:map_rendition_of,
          pattern:"(?<prefix> )MS$|(?<prefix> )MS(?<suffix>/)|(?<prefix> )MS(?<suffix> )",
