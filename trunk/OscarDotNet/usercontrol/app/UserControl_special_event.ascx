<%@ Control Language="c#" AutoEventWireup="True" Codebehind="UserControl_special_event.ascx.cs" Inherits="UserControl_special_event.TWebUserControl_special_event"%>
            ...
            <font class="compact">
              <table cellspacing="0" cellpadding="0" width="100%" border="0">
                <tr>
                  ...
                  <td valign="middle">
                    <small>
                      <ASP:LinkButton id="LinkButton_new_record" runat="server" causesvalidation="False" visible="False" onclick="LinkButton_new_record_Click">Enter brand new special_event
</ASP:LinkButton>
                    </small>
                  </td>
                </tr>
