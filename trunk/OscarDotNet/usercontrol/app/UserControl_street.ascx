<%@ Control Language="c#" AutoEventWireup="True" Codebehind="UserControl_street.ascx.cs" Inherits="UserControl_street.TWebUserControl_street"%>
...
<table cellspacing="0" cellpadding="5" width="100%" border="0">
  ...
  <tr>
    ...
    <td>
      <font class="">
        <ASP:DropDownList id="DropDownList_city" runat="server"  cssclass="" enabled="False"></ASP:DropDownList>
      </font>
    </td>
    <td nowrap="True">
      <ASP:RequiredFieldValidator id="RequiredFieldValidator_city" runat="server" errormessage="Please select a City." font-bold="True" controltovalidate="DropDownList_city">!ERR!</ASP:RequiredFieldValidator>
    </td>
  </tr>
      </table>
    </td>
