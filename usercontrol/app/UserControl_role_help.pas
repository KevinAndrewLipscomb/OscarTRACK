...
procedure TWebUserControl_role_help.InjectPersistentClientSideScript;
begin
...
procedure TWebUserControl_role_help.Page_Load(sender: System.Object; e: System.EventArgs);
begin
  //
...
procedure TWebUserControl_role_help.OnInit(e: System.EventArgs);
begin
  //
  ...
  inherited OnInit(e);
  //
  if session['UserControl_role_help.p'] <> nil then begin
    p := p_type(session['UserControl_role_help.p']);
    p.be_loaded := IsPostBack and (string(session['UserControl_member_binder_PlaceHolder_content']) = 'UserControl_role_help');
  end else begin
    //
    p.be_loaded := FALSE;
    //
...
/// </summary>
procedure TWebUserControl_role_help.InitializeComponent;
begin
  Include(Self.PreRender, Self.TWebUserControl_role_help_PreRender);
  Include(Self.Load, Self.Page_Load);
end;
{$ENDREGION}

procedure TWebUserControl_role_help.TWebUserControl_role_help_PreRender(sender: System.Object;
  e: System.EventArgs);
begin
  SessionSet('UserControl_role_help.p',p);
end;

function TWebUserControl_role_help.Fresh: TWebUserControl_role_help;
begin
