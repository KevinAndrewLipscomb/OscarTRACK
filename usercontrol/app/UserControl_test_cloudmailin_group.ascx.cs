...
namespace UserControl_test_cloudmailin_group
  {
  public partial class TWebUserControl_test_cloudmailin_group : ki_web_ui.usercontrol_class
    {
    ...
    protected override void OnInit(EventArgs e)
      ...
      if (Session[instance_id + ".p"] != null)
        ...
        //
        if (instance_id == "ASP.protected_overview_aspx.UserControl_M_test_binder_test_cloudmailin_binder_test_cloudmailin_group")
          {
          p.be_loaded &= ((Session["M_UserControl_test_binder_UserControl_test_cloudmailin_binder_PlaceHolder_content"] as string) == "UserControl_test_cloudmailin_group");
          }
        }
      else
        {
    ...
    private void InitializeComponent()
      {
      PreRender += TWebUserControl_test_cloudmailin_group_PreRender;
      }

    private void TWebUserControl_test_cloudmailin_group_PreRender(object sender, EventArgs e)
      {
      SessionSet(InstanceId() + ".p", p);
      }

    public TWebUserControl_test_cloudmailin_group Fresh()
      {
    ...
    protected void Button_process_Click(object sender, EventArgs e)
      {
      p.biz_members.ProcessCloudmailinRequest
        (
