...
namespace Class_db_driver_skills
  ...
  public class TClass_db_driver_skills: TClass_db
    ...
    public void BindDirectToListControl
      ...
      Open();
      var dr = new MySqlCommand("SELECT id,description FROM driver_skill where description <> '(none specified)' order by id", connection).ExecuteReader();
      while (dr.Read())
        {
    ...
    public bool Delete(string id)
      ...
      try
        {
        new MySqlCommand(db_trail.Saved("delete from driver_skill where id = '" + id + "'"), connection).ExecuteNonQuery();
        }
    ...
    public bool Get
      ...
      var result = false;
      Open();
      var dr = new MySqlCommand("select description from driver_skill where id = '" + id + "'", connection).ExecuteReader();
      if (dr.Read())
        {
