...
namespace UserControl_serial_indicator_scheduled_duty_compliance
{
    public partial class TWebUserControl_serial_indicator_scheduled_duty_compliance: ki_web_ui.usercontrol_class
    {
    ...
    private struct p_type
      ...
      public string width_in_months_max;
        ...
        private void Bind()
          {
          p.biz_agencies.BindForControlCharts("scheduled_duty_compliance", DataGrid_control_charts);
          }
        ...
        public TWebUserControl_serial_indicator_scheduled_duty_compliance Fresh()
        {
            TWebUserControl_serial_indicator_scheduled_duty_compliance result;
    ...
    } // end TWebUserControl_serial_indicator_scheduled_duty_compliance
