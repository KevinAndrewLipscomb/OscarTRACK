<%@ Control Language="c#" AutoEventWireup="True" Codebehind="UserControl_agency_satellite_station.ascx.cs" Inherits="UserControl_agency_satellite_station.TWebUserControl_agency_satellite_station"%>
