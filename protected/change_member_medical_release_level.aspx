			...
			<tr>
			  <td>
				<table cellspacing="0" cellpadding="10" width="100%" border="0">
					<tr><td bgcolor="#f5f5f5"><strong>Change <ASP:Label id="Label_member_name_1" runat="server"></ASP:Label>'s released cert level</strong></td>
					</tr>
					<tr>
					  <td>
                        ...
                        <table  id="HtmlTable_proper_release_reminder" runat="server" bordercolor="#ffff00" cellspacing="0" cellpadding="5" bgcolor="#ffff00" border="1">
                            <tr>
                              <td>
                              <p>Make changes only <strong>after</strong>&nbsp;the member has received the appropriate ID card from the department.&nbsp; Do <strong>not</strong>&nbsp;set a member to EMT-B unless you are <strong>positive</strong>&nbsp;that the training center has issued the member a White ID Card <strong>with no red stripe</strong>.</p></td>
                            </tr>
                        </table>
                        <br>
                      <table cellspacing="0" cellpadding="10" border="0">
                          <tr>
                            <td>
                        <ASP:Label id="Label_member_name_3" runat="server"></ASP:Label>'s current released cert level is:</td>
                            <td>
                              <asp:Label id="Label_current_medical_release_level" runat="server"></asp:Label></td>
                            <td></td>
                          </tr>
                          <tr>
                            ...
                            <td>
                              <asp:RequiredFieldValidator id="RequiredFieldValidator_medical_release_level" runat="server" errormessage="Please select a new released certification level." font-bold="True" controltovalidate="DropDownList_medical_release_level">!ERR!</asp:RequiredFieldValidator></td>
                          </tr>
                          <tr>
                            <td></td>
