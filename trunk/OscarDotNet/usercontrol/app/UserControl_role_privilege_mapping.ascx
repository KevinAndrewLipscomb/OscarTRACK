<%@ Control Language="c#" AutoEventWireup="false" Codebehind="UserControl_role_privilege_mapping.pas" Inherits="UserControl_role_privilege_mapping.TWebUserControl_role_privilege_mapping"%>
