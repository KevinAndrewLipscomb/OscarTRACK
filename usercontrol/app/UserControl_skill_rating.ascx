<%@ Control Language="c#" AutoEventWireup="True" CodeBehind="UserControl_skill_rating.ascx.cs" Inherits="UserControl_skill_rating.TWebUserControl_skill_rating" %>
  ...
  <tr>
    <td valign="top">
      <table cellspacing="0" cellpadding="5" border="0">
            ...
            <font class="compact">
              <table cellspacing="0" cellpadding="0" width="100%" border="0">
                <tr>
                  <td valign="middle">
                    <table cellspacing="0" cellpadding="0" border="0">
                      <tr>
                        ...
                        <td><small><small><asp:Label ID="Label_lookup_arrow" runat="server">&lt;--</asp:Label></small></small></td>
                  ...
                  <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                  <td valign="middle">
                    <small><asp:LinkButton ID="LinkButton_new_record" runat="server" CausesValidation="False" Visible="False" OnClick="LinkButton_new_record_Click">Enter brand new skill_rating</asp:LinkButton></small>
                  </td>
                </tr>
              </table>
              <table>
                <tr>
                  <td>
                    <asp:Panel ID="Panel_match_numbers" runat="server" Visible="False">
                      <small>(<asp:Literal ID="Literal_match_index" runat="server"></asp:Literal>/<asp:Literal ID="Literal_num_matches" runat="server"></asp:Literal>)</small>
                    </asp:Panel>
                  </td>
                  <td>
                  ...
                  <td>
                    <div style="width: 0px; white-space: nowrap;">
                      <asp:DropDownList ID="DropDownList_code" runat="server" Visible="False" AutoPostBack="True" OnSelectedIndexChanged="DropDownList_code_SelectedIndexChanged"></asp:DropDownList>
                    </div>
                  </td>
                </tr>
              </table>
        ...
        <tr>
          <td><font class="compact">Designator:</font></td>
          <td><font class="compact"><asp:TextBox ID="TextBox_designator" runat="server" Columns="1" MaxLength="1" CssClass="compact" Enabled="False"></asp:TextBox></font></td>
          <td>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator_designator" runat="server" ErrorMessage="Please enter Designator." Font-Bold="True" ControlToValidate="TextBox_designator" Display="Dynamic">!ERR!</asp:RequiredFieldValidator>
          </td>
        </tr>
        <tr>
          <td><font class="compact">Description:</font></td>
          <td><font class="compact"><asp:TextBox ID="TextBox_description" runat="server" Columns="63" MaxLength="63" CssClass="compact" Enabled="False"></asp:TextBox></font></td>
          <td>
