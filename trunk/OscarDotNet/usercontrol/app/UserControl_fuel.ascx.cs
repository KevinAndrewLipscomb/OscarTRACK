...
namespace UserControl_fuel
  {
  public partial class TWebUserControl_fuel: ki_web_ui.usercontrol_class
    {
    private p_type p;
    ...
    protected void Page_Load(object sender, System.EventArgs e)
      ...
      if (!p.be_loaded)
        {
        LinkButton_new_record.Visible = p.be_ok_to_config_fuels;
        LinkButton_go_to_match_first.Text = k.ExpandTildePath(LinkButton_go_to_match_first.Text);
        LinkButton_go_to_match_prior.Text = k.ExpandTildePath(LinkButton_go_to_match_prior.Text);
        LinkButton_go_to_match_next.Text = k.ExpandTildePath(LinkButton_go_to_match_next.Text);
        LinkButton_go_to_match_last.Text = k.ExpandTildePath(LinkButton_go_to_match_last.Text);
        RequireConfirmation(Button_delete, "Are you sure you want to delete this record?");
        if ((Session["mode:goto"] != null) && Session["mode:goto"].ToString().Contains("/fuel/"))
          {
    ...
    private bool PresentRecord(string id)
      ...
      if
        ...
        SetDependentFieldAblements(p.be_ok_to_config_fuels);
        Button_submit.Enabled = p.be_ok_to_config_fuels;
        Button_delete.Enabled = p.be_ok_to_config_fuels;
        result = true;
        }
      return result;
      }
    ...
    protected override void OnInit(System.EventArgs e)
      ...
      if (Session["UserControl_fuel.p"] != null)
        ...
        p.be_ok_to_config_fuels = k.Has((string[])(Session["privilege_array"]), "config-fleet-attributes");
        }
      }
    ...
    protected void Button_delete_Click(object sender, System.EventArgs e)
      {
      if (p.biz_fuels.Delete(k.Safe(TextBox_id.Text, k.safe_hint_type.NUM)))
        {
        SetLookupMode();
        }
      else
    ...
    protected void Button_lookup_Click(object sender, System.EventArgs e)
      ...
      if (!PresentRecord(saved_id))
        ...
        p.biz_fuels.Bind(saved_id, DropDownList_id);
