      ...
      <tr>
        <td>
          <cc1:TabContainer id="TabContainer_control" runat="server" autopostback="True" cssclass="ajax__tab_ki" CssTheme="None">
            ...
            <cc1:TabPanel runat="server" headertext="Posts" id="TabPanel_posts" enabled="False"></cc1:TabPanel>
            ...
            <cc1:TabPanel runat="server" headertext="Uniform objects" id="TabPanel_uniform_objects" enabled="False"></cc1:TabPanel>
