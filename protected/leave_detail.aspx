            ...
            <tr>
              <td>
                <table cellspacing="0" cellpadding="10" border="0">
                    <tr>
                      <td bgcolor="#f5f5f5"><strong>Leave detail for <ASP:Label id="Label_member_designator" runat="server"></ASP:Label></strong></td>
					</tr>
                      ...
                      <td>
                        <ASP:DataGrid id="DataGrid_leaves" runat="server" allowsorting="True" autogeneratecolumns="False" useaccessibleheader="True" cellpadding="10" gridlines="Horizontal" bordercolor="Gainsboro" borderwidth="1px">
                          ...
                          <Columns>
                            ...
                            <ASP:BoundColumn datafield="start_date" sortexpression="start_date" readonly="True" headertext="Start date"></ASP:BoundColumn>
                            <ASP:BoundColumn datafield="end_date" sortexpression="end_date" readonly="True" headertext="End date"></ASP:BoundColumn>
                            <ASP:BoundColumn datafield="kind_of_leave" sortexpression="kind_of_leave" readonly="True" headertext="Kind"></ASP:BoundColumn>
