...
namespace UserControl_ranked_standard_enrollment
{
    ...
    public partial class TWebUserControl_ranked_standard_enrollment: ki_web_ui.usercontrol_class
    {
        ...
        protected override void OnInit(System.EventArgs e)
        {
            ...
            InitializeComponent();
            base.OnInit(e);
            if (IsPostBack && (Session["UserControl_ranked_standard_enrollment.p"] != null) && (Session["UserControl_ranked_standard_enrollment.p"].GetType().Namespace == p.GetType().Namespace))
            {
