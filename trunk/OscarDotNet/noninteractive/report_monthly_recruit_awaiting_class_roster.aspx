<%@ Page language="c#" Debug="true" Codebehind="report_monthly_recruit_awaiting_class_roster.aspx.cs" AutoEventWireup="True" Inherits="report_monthly_recruit_awaiting_class_roster.TWebForm_report_monthly_recruit_awaiting_class_roster" EnableViewState="false" %>
			...
			<tr>
			  <td>
				<table cellspacing="0" cellpadding="10" width="100%" border="0">
					<tr>
					  <td bgcolor="#f5f5f5"><strong>Monthly report of RECRUITS WHO ARE NOT YET STUDENTS</strong></td>
					</tr>
					<tr>
					  <td>
						<small>
						...
						<ul>
						  ...
						  <li><p>Consider reminding these personnel that we are counting on them to enroll in class, and that we all found the difficult class schedule to ultimately be extremely
							rewarding.</p></li>
