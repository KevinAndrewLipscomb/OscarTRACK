<%@ Control Language="c#" AutoEventWireup="True" Codebehind="UserControl_ephemeral_dispatch.ascx.cs" Inherits="UserControl_ephemeral_dispatch.TWebUserControl_ephemeral_dispatch"%>
...
<table cellspacing="0" cellpadding="5" width="100%" border="0">
  ...
  <tr>
    ...
    <td>
      <font class="">
        <ASP:TextBox id="TextBox_designator" runat="server" columns="15" maxlength="15" cssclass="" enabled="False"></ASP:TextBox>
      </font>
    </td>
    <td nowrap="nowrap">
