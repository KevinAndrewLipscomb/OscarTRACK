...
<p>These control charts show the percentage of released core operations personnel who the agency enrolled at one of the standard levels (Regular, Life, Senior, Tenured BLS, Tenured ALS).&nbsp; The lower the data point, the more personnel the agency enrolled at liberal levels (Associate, Reduced, Staff, ALS Intern, College, Atypical).&nbsp; Standard enrollees commit more duty shifts per month than liberal enrollees.</p>
<p>
  ...
  <Columns>
	<ASP:TemplateColumn>
	  <ItemTemplate>
		...
		<p><img width="781" height="417" src='../serial_indicator_control_chart.aspx?indicator=standard_enrollment&agency=<%# DataBinder.Eval(Container.DataItem, "id") %>&be_agency_applicable=<%# DataBinder.Eval(Container.DataItem, "be_agency_id_applicable") %>' /></p>
	  </ItemTemplate>
	</ASP:TemplateColumn>
  </Columns>
</ASP:DataGrid>
