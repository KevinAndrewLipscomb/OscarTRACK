    ...
    protected void Page_Load(object sender, EventArgs e)
      ...
      if (!p.be_loaded)
        ...
        HyperLink_subscribe_via_google_calendar_render.NavigateUrl =
          "https://www.google.com/calendar/render?cid=" + Server.UrlEncode(ConfigurationManager.AppSettings["runtime_root_fullspec"].Replace("https","webcal") + p.icalendar_path_common_part);
