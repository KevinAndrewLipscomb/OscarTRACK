...
namespace UserControl_eval_status
  {

  public partial class TWebUserControl_eval_status: ki_web_ui.usercontrol_class
    {

    private struct p_type
      {
      public bool be_loaded;
      public bool be_ok_to_config_eval_statuses;
    ...
    protected void Page_Load(object sender, System.EventArgs e)
      ...
      if (!p.be_loaded)
        {
        LinkButton_new_record.Visible = p.be_ok_to_config_eval_statuses;
    ...
    private bool PresentRecord(string id)
      ...
      //
        ...
        SetDependentFieldAblements(p.be_ok_to_config_eval_statuses);
        Button_submit.Enabled = p.be_ok_to_config_eval_statuses;
        Button_delete.Enabled = p.be_ok_to_config_eval_statuses;
        result = true;
        }
      return result;
      }
    ...
    private void SetLookupMode()
      ...
      LinkButton_new_record.Enabled = p.be_ok_to_config_eval_statuses;
      TextBox_id.Focus();
      }
    ...
    protected override void OnInit(System.EventArgs e)
      ...
      if (Session[InstanceId() + ".p"] != null)
        ...
        p.be_loaded = IsPostBack && ((Session["UserControl_member_binder_UserControl_config_UserControl_business_objects_binder_PlaceHolder_content"] as string) == "UserControl_eval_status");
        }
      else
        {
        p.be_loaded = false;
        p.biz_eval_statuses = new TClass_biz_eval_statuses();
        p.be_ok_to_config_eval_statuses = k.Has((string[])(Session["privilege_array"]), "config-eval_statuses");
        }
      }
    ...
    private void InitializeComponent()
      {
      PreRender += TWebUserControl_eval_status_PreRender;
      }

    private void TWebUserControl_eval_status_PreRender(object sender, System.EventArgs e)
      {
      SessionSet(InstanceId() + ".p", p);
      }

    public TWebUserControl_eval_status Fresh()
      {
    ...
    protected void Button_submit_Click(object sender, System.EventArgs e)
      ...
      if (Page.IsValid)
        {
        p.biz_eval_statuses.Set(k.Safe(TextBox_id.Text, k.safe_hint_type.NUM), k.Safe(TextBox_description.Text, k.safe_hint_type.PUNCTUATED));
    ...
    protected void Button_delete_Click(object sender, System.EventArgs e)
      {
      if (p.biz_eval_statuses.Delete(k.Safe(TextBox_id.Text, k.safe_hint_type.ALPHANUM)))
        {
        SetLookupMode();
        }
      else
    ...
    protected void Button_lookup_Click(object sender, System.EventArgs e)
      ...
      if (!PresentRecord(saved_id))
        ...
        p.biz_eval_statuses.Bind(saved_id, DropDownList_code);
    ...
    } // end TWebUserControl_eval_status
