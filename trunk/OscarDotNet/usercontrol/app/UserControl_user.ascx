    ...
    <td valign="top">
      ...
      <table>
        <tr>
          ...
          <td>
            <div style="width:0px;white-space:nowrap;"><ASP:DropDownList id="DropDownList_username" runat="server" visible="False" autopostback="True" onselectedindexchanged="DropDownList_username_SelectedIndexChanged"></ASP:DropDownList></div>
          </td>
        </tr>
      </table></td>
    <td valign="top">
