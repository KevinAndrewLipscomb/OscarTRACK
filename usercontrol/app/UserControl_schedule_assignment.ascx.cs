...
namespace UserControl_schedule_assignment
  {
  public partial class TWebUserControl_schedule_assignment: ki_web_ui.usercontrol_class
    {
    private p_type p;
    ...
    private void Clear()
      ...
      TextBox_shift_id.Text = k.EMPTY;
      TextBox_post_id.Text = k.EMPTY;
      TextBox_post_cardinality.Text = k.EMPTY;
      TextBox_position_id.Text = k.EMPTY;
      TextBox_member_id.Text = k.EMPTY;
      CheckBox_be_selected.Checked = false;
    ...
    protected void Page_Load(object sender, System.EventArgs e)
      ...
      if (!p.be_loaded)
        {
        LinkButton_new_record.Visible = p.be_ok_to_config_schedule_assignments;
        LinkButton_go_to_match_first.Text = k.ExpandTildePath(LinkButton_go_to_match_first.Text);
        LinkButton_go_to_match_prior.Text = k.ExpandTildePath(LinkButton_go_to_match_prior.Text);
        LinkButton_go_to_match_next.Text = k.ExpandTildePath(LinkButton_go_to_match_next.Text);
        LinkButton_go_to_match_last.Text = k.ExpandTildePath(LinkButton_go_to_match_last.Text);
        RequireConfirmation(Button_delete, "Are you sure you want to delete this record?");
        if ((Session["mode:goto"] != null) && Session["mode:goto"].ToString().Contains("/schedule_assignment/"))
          {
    ...
    private bool PresentRecord(string id)
      ...
      if
        (
        p.biz_schedule_assignments.Get
          (
          id,
          out nominal_day,
          out shift_id,
        ...
        TextBox_shift_id.Text = shift_id;
        TextBox_post_id.Text = post_id;
        TextBox_post_cardinality.Text = post_cardinality;
        TextBox_position_id.Text = position_id;
        TextBox_member_id.Text = member_id;
        CheckBox_be_selected.Checked = be_selected;
        ...
        Button_delete.Enabled = p.be_ok_to_config_schedule_assignments;
        result = true;
        }
      return result;
      }
    ...
    protected override void OnInit(System.EventArgs e)
      ...
      if (Session[InstanceId() + ".p"] != null)
        ...
        p.be_ok_to_config_schedule_assignments = k.Has((string[])(Session["privilege_array"]), "config-schedule_assignments");
        }
      }
    ...
    protected void Button_submit_Click(object sender, System.EventArgs e)
      ...
      if (Page.IsValid)
        {
        p.biz_schedule_assignments.Set
          (
    ...
    protected void Button_delete_Click(object sender, System.EventArgs e)
      {
      if (p.biz_schedule_assignments.Delete(k.Safe(TextBox_id.Text, k.safe_hint_type.ALPHANUM)))
        {
        SetLookupMode();
        }
      else
    ...
    private void SetDependentFieldAblements(bool ablement)
      ...
      TextBox_shift_id.Enabled = ablement;
      TextBox_post_id.Enabled = ablement;
      TextBox_post_cardinality.Enabled = ablement;
      TextBox_position_id.Enabled = ablement;
      TextBox_member_id.Enabled = ablement;
      CheckBox_be_selected.Enabled = ablement;
    ...
    protected void Button_lookup_Click(object sender, System.EventArgs e)
      ...
      if (!PresentRecord(saved_id))
        ...
        p.biz_schedule_assignments.Bind(saved_id, DropDownList_id);
