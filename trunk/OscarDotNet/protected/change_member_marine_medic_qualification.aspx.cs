...
namespace change_member_marine_medic_qualification
{
    ...
    public partial class TWebForm_change_member_marine_medic_qualification: ki_web_ui.page_class
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.PreRender += this.TWebForm_change_member_marine_medic_qualification_PreRender;
        }
        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    p.be_marine_medic_initially_qualified = p.biz_members.BeMarineMedicQualifiedOf(Session["member_summary"]);
                    RadioButtonList_marine_medic_qualified_yes_no.SelectedValue = k.YesNoOf(p.be_marine_medic_initially_qualified);
                }
            }
        }
        ...
        {
            bool be_marine_medic_qualified;
        ...
        private void TWebForm_change_member_marine_medic_qualification_PreRender(object sender, System.EventArgs e)
        {
            SessionSet(InstanceId() + ".p", p);
        }

    } // end TWebForm_change_member_marine_medic_qualification
