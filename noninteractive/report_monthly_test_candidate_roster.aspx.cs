...
namespace report_monthly_test_candidate_roster
{
    ...
    public partial class TWebForm_report_monthly_test_candidate_roster: System.Web.UI.Page
    {
        ...
        {
            string url;
            Title.InnerText = ConfigurationManager.AppSettings["application_name"] + " - report_monthly_test_candidate_roster";
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            this.Session.Add("mode:report/monthly-test-candidate-roster", k.EMPTY);
