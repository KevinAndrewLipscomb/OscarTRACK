...
namespace Class_db_incident_natures
  ...
  public class TClass_db_incident_natures: TClass_db
    ...
    public bool Delete(string id)
      ...
      try
        {
        using var my_sql_command = new MySqlCommand(db_trail.Saved("delete from incident_nature where id = \"" + id + "\""), connection);
    ...
    public bool Get
      ...
      //
      Open();
      using var my_sql_command = new MySqlCommand("select * from incident_nature where CAST(id AS CHAR) = \"" + id + "\"", connection);
      var dr = my_sql_command.ExecuteReader();
      if (dr.Read())
        {
