<%@ Control Language="c#" AutoEventWireup="True" Codebehind="UserControl_uniform_piece_color.ascx.cs" Inherits="UserControl_uniform_piece_color.TWebUserControl_uniform_piece_color"%>
