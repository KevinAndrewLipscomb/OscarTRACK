...
namespace UserControl_rank_group
  {
  public partial class TWebUserControl_rank_group: ki_web_ui.usercontrol_class
    {
    private struct p_type
      ...
      public bool be_ok_to_config_rank_groups;
      public string id;
    ...
    protected void Page_Load(object sender, System.EventArgs e)
      ...
      if (!p.be_loaded)
        {
        LinkButton_new_record.Visible = p.be_ok_to_config_rank_groups;
    ...
    private bool PresentRecord(string id)
      ...
      if
        ...
        SetDependentFieldAblements(p.be_ok_to_config_rank_groups);
        Button_submit.Enabled = p.be_ok_to_config_rank_groups;
        Button_delete.Enabled = p.be_ok_to_config_rank_groups;
        result = true;
        }
      return result;
      }
...
//        {
//        p.be_loaded &= ((Session["UserControl_~_binder_PlaceHolder_content"] as string) == "UserControl_rank_group");
//        }
        }
      else
        {
    ...
    public TWebUserControl_rank_group Fresh()
      {
    ...
    protected void Button_submit_Click(object sender, System.EventArgs e)
      ...
      if (Page.IsValid)
        {
        p.biz_rank_groups.Set
          (
          k.Safe(TextBox_id.Text,k.safe_hint_type.NUM),
          k.Safe(TextBox_agency_id.Text,k.safe_hint_type.NUM).Trim(),
          k.Safe(TextBox_name.Text,k.safe_hint_type.ALPHA).Trim(),
    ...
    protected void Button_delete_Click(object sender, System.EventArgs e)
      {
      if (p.biz_rank_groups.Delete(k.Safe(TextBox_id.Text, k.safe_hint_type.NUM)))
        {
        SetLookupMode();
        }
      else
    ...
    protected void Button_lookup_Click(object sender, System.EventArgs e)
      ...
      if (!PresentRecord(saved_id))
        ...
        p.biz_rank_groups.Bind(saved_id, DropDownList_id);
    ...
    internal void SetP
      ...
      if (id.Length > 0)
        {
        p.id = id;
        p.summary = p.biz_rank_groups.Summary(id);
        //p.be_ok_to_config_rank_groups = p.biz_privileges.HasForAgency
        //  (
        //  member_id:p.biz_members.IdOfUserId(p.biz_user.IdNum()),
        //  privilege_name:"config-rank_groups",
        //  agency_id:p.biz_rank_groups.AgencyIdOf(p.summary)
        //  );
        p.presentation_mode = (p.be_ok_to_config_rank_groups ? presentation_mode_enum.FULL_FUNCTION : p.presentation_mode = presentation_mode_enum.REVIEW_ONLY);
        }
      else
        {
        p.id = k.EMPTY;
    ...
    } // end TWebUserControl_rank_group
