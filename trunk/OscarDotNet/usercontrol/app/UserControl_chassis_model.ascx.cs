...
namespace UserControl_chassis_model
  {
  public partial class TWebUserControl_chassis_model: ki_web_ui.usercontrol_class
    {
    private struct p_type
      ...
      public bool be_ok_to_config_chassis_models;
      }
    ...
    protected void Page_Load(object sender, System.EventArgs e)
      ...
      if (!p.be_loaded)
        {
        p.biz_chassis_makes.BindDirectToListControl(DropDownList_make);
        DropDownList_make.Items.Insert(0,(new ListItem("-- make --",k.EMPTY)));
        LinkButton_new_record.Visible = p.be_ok_to_config_chassis_models;
        LinkButton_go_to_match_first.Text = k.ExpandTildePath(LinkButton_go_to_match_first.Text);
        LinkButton_go_to_match_prior.Text = k.ExpandTildePath(LinkButton_go_to_match_prior.Text);
        LinkButton_go_to_match_next.Text = k.ExpandTildePath(LinkButton_go_to_match_next.Text);
        LinkButton_go_to_match_last.Text = k.ExpandTildePath(LinkButton_go_to_match_last.Text);
        RequireConfirmation(Button_delete, "Are you sure you want to delete this record?");
        if ((Session["mode:goto"] != null) && Session["mode:goto"].ToString().Contains("/chassis_model/"))
          {
    ...
    private bool PresentRecord(string id)
      ...
      if
        ...
        SetDependentFieldAblements(p.be_ok_to_config_chassis_models);
        Button_submit.Enabled = p.be_ok_to_config_chassis_models;
        Button_delete.Enabled = p.be_ok_to_config_chassis_models;
        result = true;
        }
      return result;
      }
    ...
    protected override void OnInit(System.EventArgs e)
      ...
      if (Session["UserControl_chassis_model.p"] != null)
        ...
        p.be_loaded = IsPostBack && ((Session["M_UserControl_config_UserControl_business_objects_binder_PlaceHolder_content"] as string) == "UserControl_chassis_model");
        }
      else
        {
        p.be_loaded = false;
        p.biz_chassis_makes = new TClass_biz_chassis_makes();
        p.biz_chassis_models = new TClass_biz_chassis_models();
        p.biz_role_member_map = new TClass_biz_role_member_map();
        p.be_ok_to_config_chassis_models = k.Has((string[])(Session["privilege_array"]), "config-fleet-attributes");
        }
      }
    ...
    protected void Button_delete_Click(object sender, System.EventArgs e)
      {
      if (p.biz_chassis_models.Delete(k.Safe(TextBox_id.Text, k.safe_hint_type.NUM)))
        {
        SetLookupMode();
        }
      else
    ...
    protected void Button_lookup_Click(object sender, System.EventArgs e)
      ...
      if (!PresentRecord(saved_id))
        ...
        p.biz_chassis_models.Bind(saved_id, DropDownList_id);
    ...
    } // end TWebUserControl_chassis_model
