  ...
  public partial class TWebUserControl_schedule_assignment_assistant_binder: ki_web_ui.usercontrol_class
    ...
    protected override void OnInit(System.EventArgs e)
      ...
      if (Session["UserControl_schedule_assignment_assistant_binder.p"] != null)
        ...
        if (p.tab_index == UserControl_schedule_assignment_assistant_binder_Static.TSSI_INTRO)
          {
          p.content_id = AddIdentifiedControlToPlaceHolder(((TWebUserControl_schedule_assignment_assistant_intro)(LoadControl("~/usercontrol/app/UserControl_schedule_assignment_assistant_intro.ascx"))), "UserControl_schedule_assignment_assistant_intro", PlaceHolder_content);
          }
        else if (p.tab_index == UserControl_schedule_assignment_assistant_binder_Static.TSSI_ALERT)
          {
          p.content_id = AddIdentifiedControlToPlaceHolder(((TWebUserControl_schedule_assignment_assistant_alert_binder)(LoadControl("~/usercontrol/app/UserControl_schedule_assignment_assistant_alert_binder.ascx"))), "UserControl_schedule_assignment_assistant_alert_binder", PlaceHolder_content);
          }
        else if (p.tab_index == UserControl_schedule_assignment_assistant_binder_Static.TSSI_PROPOSAL)
          {
          p.content_id = AddIdentifiedControlToPlaceHolder(((TWebUserControl_schedule_proposal)(LoadControl("~/usercontrol/app/UserControl_schedule_proposal.ascx"))), "UserControl_schedule_proposal", PlaceHolder_content);
          }
        }
      else
        {
        ...
        p.content_id = AddIdentifiedControlToPlaceHolder(((TWebUserControl_schedule_assignment_assistant_intro)(LoadControl("~/usercontrol/app/UserControl_schedule_assignment_assistant_intro.ascx"))).Fresh(), "UserControl_schedule_assignment_assistant_intro", PlaceHolder_content);
        }
      }
    ...
    private void TabContainer_control_ActiveTabChanged(object sender, System.EventArgs e)
      ...
      if (p.tab_index == UserControl_schedule_assignment_assistant_binder_Static.TSSI_INTRO)
        ...
        {
        p.content_id = AddIdentifiedControlToPlaceHolder(((TWebUserControl_schedule_assignment_assistant_alert_binder)(LoadControl("~/usercontrol/app/UserControl_schedule_assignment_assistant_alert_binder.ascx"))).Fresh(), "UserControl_schedule_assignment_assistant_alert_binder", PlaceHolder_content);
        }
      else if (p.tab_index == UserControl_schedule_assignment_assistant_binder_Static.TSSI_PROPOSAL)
        {
        p.content_id = AddIdentifiedControlToPlaceHolder(((TWebUserControl_schedule_proposal)(LoadControl("~/usercontrol/app/UserControl_schedule_proposal.ascx"))).Fresh(), "UserControl_schedule_proposal", PlaceHolder_content);
        }
      }
