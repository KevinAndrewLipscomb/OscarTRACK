<%@ Control Language="c#" AutoEventWireup="True" Codebehind="UserControl_incident_nature.ascx.cs" Inherits="UserControl_incident_nature.TWebUserControl_incident_nature"%>
