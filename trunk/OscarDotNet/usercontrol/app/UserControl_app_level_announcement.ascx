...
<ajaxToolkit:DropShadowExtender ID="Panel_content_DropShadowExtender" runat="server" BehaviorID="Panel_content_DropShadowExtender" TargetControlID="Panel_content" />
<br />
