<%@ Control Language="c#" AutoEventWireup="True" Codebehind="UserControl_rank_group.ascx.cs" Inherits="UserControl_rank_group.TWebUserControl_rank_group"%>
...
<table cellspacing="0" cellpadding="5" width="100%" border="0">
  ...
  <tr>
    ...
    <td>
      <font class="">
        <ASP:TextBox id="TextBox_name" runat="server" columns="15" maxlength="15" cssclass="" enabled="False"></ASP:TextBox>
      </font>
    </td>
    <td nowrap="nowrap">
