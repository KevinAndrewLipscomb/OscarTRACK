<%@ Control Language="c#" AutoEventWireup="True" Codebehind="UserControl_uniform_piece_make.ascx.cs" Inherits="UserControl_uniform_piece_make.TWebUserControl_uniform_piece_make"%>
