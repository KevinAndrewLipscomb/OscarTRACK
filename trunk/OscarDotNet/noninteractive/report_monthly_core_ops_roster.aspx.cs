...
namespace report_monthly_core_ops_roster
{
    public partial class TWebForm_report_monthly_core_ops_roster: ki_web_ui.page_class
    {
    private struct p_type
    {
        ...
        {
            string url;
            Title = Server.HtmlEncode(ConfigurationManager.AppSettings["application_name"]) + " - report_monthly_current_roster";
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            Session.Add("mode:report/monthly-core-ops-roster", k.EMPTY);
            ...
            {
                p.role_name = "Department Scheduler";
                Session.Add("privilege_array", new string[1] {"see-all-squads"});
            }
            else
            {
                p.role_name = "Squad Scheduler";
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            // body
            // be_html
            k.SmtpMailSend(ConfigurationManager.AppSettings["sender_email_address"], p.biz_role_member_map.EmailTargetOf(p.role_name, p.agency_short_designator), "Report: Monthly Core Ops Roster", body, true);
            Session.Abandon();

        }

    } // end TWebForm_report_monthly_core_ops_roster
