<%@ Control Language="c#" AutoEventWireup="True" Codebehind="UserControl_capcode_unit_map.ascx.cs" Inherits="UserControl_capcode_unit_map.TWebUserControl_capcode_unit_map"%>
...
<table cellspacing="0" cellpadding="5" width="100%" border="0">
  ...
  <tr>
    <td><font class="">Unit:</font></td>
    <td>
      <font class="">
        <ASP:TextBox id="TextBox_unit" runat="server" columns="7" maxlength="7" cssclass="" enabled="False"></ASP:TextBox>
      </font>
    </td>
    <td nowrap="nowrap">
