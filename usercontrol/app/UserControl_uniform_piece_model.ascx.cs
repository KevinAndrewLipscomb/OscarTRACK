...
//        }
    ...
    protected void Button_submit_Click(object sender, System.EventArgs e)
      ...
      if (Page.IsValid)
        ...
        p.biz_uniform_piece_models.Set
          ...
          k.Safe(TextBox_make_id.Text,k.safe_hint_type.NUM).Trim(),
    ...
    private void SetDependentFieldAblements(bool ablement)
      {
      TextBox_make_id.Enabled = ablement;
    ...
    protected void Button_lookup_Click(object sender, System.EventArgs e)
      ...
      if (!PresentRecord(saved_id))
        ...
        p.biz_uniform_piece_models.Bind(saved_id, DropDownList_id);
    ...
    internal void SetP
      ...
      if (id.Length > 0)
        ...
        //  );
        p.presentation_mode = (p.be_ok_to_config_uniform_piece_models ? presentation_mode_enum.FULL_FUNCTION : p.presentation_mode = presentation_mode_enum.REVIEW_ONLY);
        }
      else
        {
        p.id = k.EMPTY;
