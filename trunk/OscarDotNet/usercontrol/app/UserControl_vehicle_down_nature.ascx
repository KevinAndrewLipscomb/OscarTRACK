<%@ Control Language="c#" AutoEventWireup="True" Codebehind="UserControl_vehicle_down_nature.ascx.cs" Inherits="UserControl_vehicle_down_nature.TWebUserControl_vehicle_down_nature"%>
...
<table cellspacing="0" cellpadding="5" width="100%" border="0">
  ...
  <tr>
    <td><font class="">Be&nbsp;failure:</font></td>
    <td>
      <font class="">
        <ASP:CheckBox id="CheckBox_be_failure" runat="server"  cssclass="" enabled="False"></ASP:CheckBox>
      </font>
    </td>
    <td nowrap="True">
    </td>
  ...
  <tr>
    ...
    <td>
      <font class="">
        <ASP:TextBox id="TextBox_elaboration" runat="server" columns="0" maxlength="0" textmode="MultiLine" rows="2" cssclass="" enabled="False"></ASP:TextBox>
      </font>
    </td>
    <td nowrap="True">
