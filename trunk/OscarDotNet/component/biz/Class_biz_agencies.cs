    ...
    internal bool BeKeyclickEnabled(string id)
      ...
      return db_agencies.BeKeyclickEnabled(id);
        ...
        internal void BindEmsPostListItemCollectionShort
          ...
          {
          db_agencies.BindEmsPostListItemCollectionShort(tier,agency_filter,post_footprint,be_condensed,be_user_squad_truck_team_scheduler,be_user_volunteer_field_supervisor_team_scheduler,target);
          }
