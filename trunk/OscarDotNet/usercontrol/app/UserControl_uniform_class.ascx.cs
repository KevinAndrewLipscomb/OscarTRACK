...
namespace UserControl_uniform_class
  {
  public partial class TWebUserControl_uniform_class: ki_web_ui.usercontrol_class
    {
    ...
    protected override void OnInit(System.EventArgs e)
      ...
      if (Session[instance_id + ".p"] != null)
        ...
        //
        if (instance_id == "ASP.protected_overview_aspx.UserControl_M_config_business_objects_binder_uniform_object_binder_uniform_class")
          {
          p.be_loaded &= ((Session["M_UserControl_config_UserControl_business_objects_binder_UserControl_uniform_object_binder_PlaceHolder_content"] as string) == "UserControl_uniform_class");
          }
//      else if (instance_id == "ASP.~_aspx.UserControl_~_binder_uniform_class")
//        {
//        p.be_loaded &= ((Session["UserControl_~_binder_PlaceHolder_content"] as string) == "UserControl_uniform_class");
//        }
        }
      else
        {
    ...
    public TWebUserControl_uniform_class Fresh()
      {
    ...
    } // end TWebUserControl_uniform_class
