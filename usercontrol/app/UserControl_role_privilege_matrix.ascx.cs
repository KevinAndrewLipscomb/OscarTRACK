...
namespace UserControl_role_privilege_matrix
{
    ...
    public partial class TWebUserControl_role_privilege_matrix: ki_web_ui.usercontrol_class
    {
        ...
        protected override void OnInit(System.EventArgs e)
        {
            ...
            InitializeComponent();
            base.OnInit(e);
            if (Session["UserControl_role_privilege_matrix.p"] != null)
            {
                p = (p_type)(Session["UserControl_role_privilege_matrix.p"]);
                p.be_loaded = IsPostBack && ((Session["M_UserControl_config_UserControl_roles_and_matrices_binder_PlaceHolder_content"] as string) == "UserControl_role_privilege_matrix");
            }
            else
            {
                ...
                p.sort_order = Units.UserControl_role_privilege_matrix.INITIAL_SORT_ORDER;
            }
        ...
        private void Bind()
        {
            ...
            uint i;
            p.biz_role_privilege_map.Bind(p.tier_filter, p.sort_order, p.be_sort_order_descending, GridView_control, out p.crosstab_metadata_rec_arraylist);
...
namespace UserControl_role_privilege_matrix.Units
{
    public class UserControl_role_privilege_matrix
    {
        ...
        public const string INITIAL_SORT_ORDER = "privilege_name%";
