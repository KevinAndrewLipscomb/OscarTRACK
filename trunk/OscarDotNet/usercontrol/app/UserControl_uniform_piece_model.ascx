<%@ Control Language="c#" AutoEventWireup="True" Codebehind="UserControl_uniform_piece_model.ascx.cs" Inherits="UserControl_uniform_piece_model.TWebUserControl_uniform_piece_model"%>
...
<table cellspacing="0" cellpadding="5" width="100%" border="0">
  ...
  <tr>
    ...
    <td>
      <font class="">
        <ASP:TextBox id="TextBox_name" runat="server" columns="72" maxlength="255" cssclass="" enabled="False"></ASP:TextBox>
      </font>
    </td>
    <td nowrap="nowrap">
