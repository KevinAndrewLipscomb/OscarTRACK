<%@ Control Language="c#" AutoEventWireup="false" Codebehind="UserControl_funddrive_binder.pas" Inherits="UserControl_funddrive_binder.TWebUserControl_funddrive_binder"%>
