...
<%@ Register src="usercontrol/app/UserControl_field_situation.ascx" tagname="UserControl_field_situation" tagprefix="uc2" %>
...
<html>
  ...
  <body bgcolor="white">
    <form runat="server">
      ...
      <uc2:UserControl_field_situation ID="UserControl_field_situation_control" runat="server" />
