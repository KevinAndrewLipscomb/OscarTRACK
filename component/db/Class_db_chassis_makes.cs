...
namespace Class_db_chassis_makes
  {
  public class TClass_db_chassis_makes: TClass_db
    ...
    public bool Get
      ...
      //
      Open();
      using var my_sql_command = new MySqlCommand("select * from chassis_make where CAST(id AS CHAR) = \"" + id + "\"", connection);
      dr = my_sql_command.ExecuteReader();
      if (dr.Read())
        {
