<%@ Control Language="c#" AutoEventWireup="True" Codebehind="UserControl_special_event_shift.ascx.cs" Inherits="UserControl_special_event_shift.TWebUserControl_special_event_shift"%>
...
<table cellspacing="0" cellpadding="5" width="100%" border="0">
  ...
  <tr>
    <td><font class="">Special&nbsp;event&nbsp;id:</font></td>
    <td>
      <font class="">
        <ASP:TextBox id="TextBox_special_event_id" runat="server"  cssclass="" enabled="False"></ASP:TextBox>
      </font>
    </td>
    <td nowrap="True">
      <ASP:RequiredFieldValidator id="RequiredFieldValidator_special_event_id" runat="server" errormessage="Please enter Special&nbsp;event&nbsp;id." font-bold="True" controltovalidate="TextBox_special_event_id">!ERR!</ASP:RequiredFieldValidator>
      <ASP:RegularExpressionValidator id="RegularExpressionValidator_special_event_id" runat="server" errormessage="Please enter a valid Special&nbsp;event&nbsp;id." font-bold="True" controltovalidate="TextBox_special_event_id" validationexpression="-?\d+">!ERR!</ASP:RegularExpressionValidator>
    </td>
  </tr>
  <tr>
