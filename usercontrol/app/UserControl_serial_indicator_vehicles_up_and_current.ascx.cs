...
namespace UserControl_serial_indicator_vehicles_up_and_current
{
    ...
    public partial class TWebUserControl_serial_indicator_vehicles_up_and_current: ki_web_ui.usercontrol_class
    {
        private p_type p;
        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            if (!p.be_loaded)
            {
                p.biz_agencies.BindForControlCharts("monthly_vehicles_up_and_current", DataGrid_control_charts);
                p.be_loaded = true;
            }
    ...
    } // end TWebUserControl_serial_indicator_vehicles_up_and_current
