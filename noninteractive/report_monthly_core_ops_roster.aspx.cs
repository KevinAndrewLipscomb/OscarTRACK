...
namespace report_monthly_core_ops_roster
{
    ...
    public partial class TWebForm_report_monthly_core_ops_roster: System.Web.UI.Page
    {
        private p_type p;
        // / <summary>
        ...
        {
            string url;
            Title.InnerText = ConfigurationManager.AppSettings["application_name"] + " - report_monthly_current_roster";
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            this.Session.Add("mode:report/monthly-core-ops-roster", k.EMPTY);
