  ...
  public class TClass_db_schedule_assignments: TClass_db
    ...
    internal void BindAmbulanceStaffingTimeLineChartBaseDataList
      ...
      target.DataSource = new MySqlCommand
        ...
        +   " ("
        +   " select nominal_day"
        +   " , FORMAT(SUM(CAST('000000' AS TIME) >= muster_to_logon_timespan AND CAST('000000' AS TIME) < muster_to_logoff_timespan)/2,1) as d0000"
        +   " , FORMAT(SUM(CAST('003000' AS TIME) >= muster_to_logon_timespan AND CAST('003000' AS TIME) < muster_to_logoff_timespan)/2,1) as d0030"
        +   " , FORMAT(SUM(CAST('010000' AS TIME) >= muster_to_logon_timespan AND CAST('010000' AS TIME) < muster_to_logoff_timespan)/2,1) as d0100"
        +   " , FORMAT(SUM(CAST('013000' AS TIME) >= muster_to_logon_timespan AND CAST('013000' AS TIME) < muster_to_logoff_timespan)/2,1) as d0130"
        +   " , FORMAT(SUM(CAST('020000' AS TIME) >= muster_to_logon_timespan AND CAST('020000' AS TIME) < muster_to_logoff_timespan)/2,1) as d0200"
        +   " , FORMAT(SUM(CAST('023000' AS TIME) >= muster_to_logon_timespan AND CAST('023000' AS TIME) < muster_to_logoff_timespan)/2,1) as d0230"
        +   " , FORMAT(SUM(CAST('030000' AS TIME) >= muster_to_logon_timespan AND CAST('030000' AS TIME) < muster_to_logoff_timespan)/2,1) as d0300"
        +   " , FORMAT(SUM(CAST('033000' AS TIME) >= muster_to_logon_timespan AND CAST('033000' AS TIME) < muster_to_logoff_timespan)/2,1) as d0330"
        +   " , FORMAT(SUM(CAST('040000' AS TIME) >= muster_to_logon_timespan AND CAST('040000' AS TIME) < muster_to_logoff_timespan)/2,1) as d0400"
        +   " , FORMAT(SUM(CAST('043000' AS TIME) >= muster_to_logon_timespan AND CAST('043000' AS TIME) < muster_to_logoff_timespan)/2,1) as d0430"
        +   " , FORMAT(SUM(CAST('050000' AS TIME) >= muster_to_logon_timespan AND CAST('050000' AS TIME) < muster_to_logoff_timespan)/2,1) as d0500"
        +   " , FORMAT(SUM(CAST('053000' AS TIME) >= muster_to_logon_timespan AND CAST('053000' AS TIME) < muster_to_logoff_timespan)/2,1) as d0530"
        +   " , FORMAT(SUM(CAST('060000' AS TIME) >= muster_to_logon_timespan AND CAST('060000' AS TIME) < muster_to_logoff_timespan)/2,1) as d0600"
        +   " , FORMAT(SUM(CAST('063000' AS TIME) >= muster_to_logon_timespan AND CAST('063000' AS TIME) < muster_to_logoff_timespan)/2,1) as d0630"
        +   " , FORMAT(SUM(CAST('070000' AS TIME) >= muster_to_logon_timespan AND CAST('070000' AS TIME) < muster_to_logoff_timespan)/2,1) as d0700"
        +   " , FORMAT(SUM(CAST('073000' AS TIME) >= muster_to_logon_timespan AND CAST('073000' AS TIME) < muster_to_logoff_timespan)/2,1) as d0730"
        +   " , FORMAT(SUM(CAST('080000' AS TIME) >= muster_to_logon_timespan AND CAST('080000' AS TIME) < muster_to_logoff_timespan)/2,1) as d0800"
        +   " , FORMAT(SUM(CAST('083000' AS TIME) >= muster_to_logon_timespan AND CAST('083000' AS TIME) < muster_to_logoff_timespan)/2,1) as d0830"
        +   " , FORMAT(SUM(CAST('090000' AS TIME) >= muster_to_logon_timespan AND CAST('090000' AS TIME) < muster_to_logoff_timespan)/2,1) as d0900"
        +   " , FORMAT(SUM(CAST('093000' AS TIME) >= muster_to_logon_timespan AND CAST('093000' AS TIME) < muster_to_logoff_timespan)/2,1) as d0930"
        +   " , FORMAT(SUM(CAST('100000' AS TIME) >= muster_to_logon_timespan AND CAST('100000' AS TIME) < muster_to_logoff_timespan)/2,1) as d1000"
        +   " , FORMAT(SUM(CAST('103000' AS TIME) >= muster_to_logon_timespan AND CAST('103000' AS TIME) < muster_to_logoff_timespan)/2,1) as d1030"
        +   " , FORMAT(SUM(CAST('110000' AS TIME) >= muster_to_logon_timespan AND CAST('110000' AS TIME) < muster_to_logoff_timespan)/2,1) as d1100"
        +   " , FORMAT(SUM(CAST('113000' AS TIME) >= muster_to_logon_timespan AND CAST('113000' AS TIME) < muster_to_logoff_timespan)/2,1) as d1130"
        +   " from schedule_assignment"
        +     " join shift on (shift.id=schedule_assignment.shift_id)"
        +     " join member on (member.id=schedule_assignment.member_id)"
        +     " join medical_release_code_description_map on (medical_release_code_description_map.code=member.medical_release_code)"
        ...
        +   " ("
        +   " select nominal_day"
        +   " , FORMAT(SUM(CAST('000000' AS TIME) >= muster_to_logon_timespan AND CAST('000000' AS TIME) < muster_to_logoff_timespan)/2,1) as n0000"
        +   " , FORMAT(SUM(CAST('003000' AS TIME) >= muster_to_logon_timespan AND CAST('003000' AS TIME) < muster_to_logoff_timespan)/2,1) as n0030"
        +   " , FORMAT(SUM(CAST('010000' AS TIME) >= muster_to_logon_timespan AND CAST('010000' AS TIME) < muster_to_logoff_timespan)/2,1) as n0100"
        +   " , FORMAT(SUM(CAST('013000' AS TIME) >= muster_to_logon_timespan AND CAST('013000' AS TIME) < muster_to_logoff_timespan)/2,1) as n0130"
        +   " , FORMAT(SUM(CAST('020000' AS TIME) >= muster_to_logon_timespan AND CAST('020000' AS TIME) < muster_to_logoff_timespan)/2,1) as n0200"
        +   " , FORMAT(SUM(CAST('023000' AS TIME) >= muster_to_logon_timespan AND CAST('023000' AS TIME) < muster_to_logoff_timespan)/2,1) as n0230"
        +   " , FORMAT(SUM(CAST('030000' AS TIME) >= muster_to_logon_timespan AND CAST('030000' AS TIME) < muster_to_logoff_timespan)/2,1) as n0300"
        +   " , FORMAT(SUM(CAST('033000' AS TIME) >= muster_to_logon_timespan AND CAST('033000' AS TIME) < muster_to_logoff_timespan)/2,1) as n0330"
        +   " , FORMAT(SUM(CAST('040000' AS TIME) >= muster_to_logon_timespan AND CAST('040000' AS TIME) < muster_to_logoff_timespan)/2,1) as n0400"
        +   " , FORMAT(SUM(CAST('043000' AS TIME) >= muster_to_logon_timespan AND CAST('043000' AS TIME) < muster_to_logoff_timespan)/2,1) as n0430"
        +   " , FORMAT(SUM(CAST('050000' AS TIME) >= muster_to_logon_timespan AND CAST('050000' AS TIME) < muster_to_logoff_timespan)/2,1) as n0500"
        +   " , FORMAT(SUM(CAST('053000' AS TIME) >= muster_to_logon_timespan AND CAST('053000' AS TIME) < muster_to_logoff_timespan)/2,1) as n0530"
        +   " , FORMAT(SUM(CAST('060000' AS TIME) >= muster_to_logon_timespan AND CAST('060000' AS TIME) < muster_to_logoff_timespan)/2,1) as n0600"
        +   " , FORMAT(SUM(CAST('063000' AS TIME) >= muster_to_logon_timespan AND CAST('063000' AS TIME) < muster_to_logoff_timespan)/2,1) as n0630"
        +   " , FORMAT(SUM(CAST('070000' AS TIME) >= muster_to_logon_timespan AND CAST('070000' AS TIME) < muster_to_logoff_timespan)/2,1) as n0700"
        +   " , FORMAT(SUM(CAST('073000' AS TIME) >= muster_to_logon_timespan AND CAST('073000' AS TIME) < muster_to_logoff_timespan)/2,1) as n0730"
        +   " , FORMAT(SUM(CAST('080000' AS TIME) >= muster_to_logon_timespan AND CAST('080000' AS TIME) < muster_to_logoff_timespan)/2,1) as n0800"
        +   " , FORMAT(SUM(CAST('083000' AS TIME) >= muster_to_logon_timespan AND CAST('083000' AS TIME) < muster_to_logoff_timespan)/2,1) as n0830"
        +   " , FORMAT(SUM(CAST('090000' AS TIME) >= muster_to_logon_timespan AND CAST('090000' AS TIME) < muster_to_logoff_timespan)/2,1) as n0900"
        +   " , FORMAT(SUM(CAST('093000' AS TIME) >= muster_to_logon_timespan AND CAST('093000' AS TIME) < muster_to_logoff_timespan)/2,1) as n0930"
        +   " , FORMAT(SUM(CAST('100000' AS TIME) >= muster_to_logon_timespan AND CAST('100000' AS TIME) < muster_to_logoff_timespan)/2,1) as n1000"
        +   " , FORMAT(SUM(CAST('103000' AS TIME) >= muster_to_logon_timespan AND CAST('103000' AS TIME) < muster_to_logoff_timespan)/2,1) as n1030"
        +   " , FORMAT(SUM(CAST('110000' AS TIME) >= muster_to_logon_timespan AND CAST('110000' AS TIME) < muster_to_logoff_timespan)/2,1) as n1100"
        +   " , FORMAT(SUM(CAST('113000' AS TIME) >= muster_to_logon_timespan AND CAST('113000' AS TIME) < muster_to_logoff_timespan)/2,1) as n1130"
        +   " from schedule_assignment"
        +     " join shift on (shift.id=schedule_assignment.shift_id)"
        +     " join member on (member.id=schedule_assignment.member_id)"
        +     " join medical_release_code_description_map on (medical_release_code_description_map.code=member.medical_release_code)"
    ...
    internal void BindSubmissionCompliancyBaseDataList
      ...
      if (compliancy_filter == "0") // holdouts
        {
        filter += " and (enrollment_level.description not in ('Staff','ALS Intern','College','Atypical','SpecOps'" + (show_transferring_members ? ",'Transferring'" : k.EMPTY) + ")) and (condensed_schedule_assignment.member_id is null)";
        }
    ...
    internal TimeSpan ShiftEndOf(object summary)
      {
    ...
    internal TimeSpan ShiftStartOf(object summary)
      {
