...
namespace UserControl_sms_gateway
  {
  public partial class TWebUserControl_sms_gateway: ki_web_ui.usercontrol_class
    {
    ...
    private void Clear()
      ...
      TextBox_carrier_name.Text = k.EMPTY;
      TextBox_hostname.Text = k.EMPTY;
    ...
    protected void Page_Load(object sender, System.EventArgs e)
      ...
      if (!p.be_loaded)
        {
        LinkButton_new_record.Visible = p.be_ok_to_config_sms_gateways;
    ...
    private bool PresentRecord(string id)
      ...
      if
        ...
        TextBox_carrier_name.Text = carrier_name;
        TextBox_hostname.Text = hostname;
        Button_lookup.Enabled = false;
        Label_lookup_arrow.Enabled = false;
        Label_lookup_hint.Enabled = false;
        LinkButton_reset.Enabled = true;
        SetDependentFieldAblements(p.be_ok_to_config_sms_gateways);
        Button_submit.Enabled = p.be_ok_to_config_sms_gateways;
        Button_delete.Enabled = p.be_ok_to_config_sms_gateways;
        result = true;
        }
      return result;
      }
    ...
    protected override void OnInit(System.EventArgs e)
      ...
      if (Session[InstanceId() + ".p"] != null)
        ...
        p.be_loaded = IsPostBack && ((Session["UserControl_member_binder_UserControl_config_binder_PlaceHolder_content"] as string) == "UserControl_sms_gateway");
        }
      else
        {
        p.be_loaded = false;
        ...
        p.be_ok_to_config_sms_gateways = k.Has((string[])(Session["privilege_array"]), "config-sms-gateways");
        }
      }
    ...
    public TWebUserControl_sms_gateway Fresh()
      {
    ...
    protected void Button_submit_Click(object sender, System.EventArgs e)
      ...
      if (Page.IsValid)
        {
        p.biz_sms_gateways.Set
          (
          k.Safe(TextBox_id.Text,k.safe_hint_type.NUM),
          k.Safe(TextBox_carrier_name.Text,k.safe_hint_type.ORG_NAME).Trim(),
          k.Safe(TextBox_hostname.Text,k.safe_hint_type.HOSTNAME)
          );
    ...
    protected void Button_delete_Click(object sender, System.EventArgs e)
      {
      if (p.biz_sms_gateways.Delete(k.Safe(TextBox_id.Text, k.safe_hint_type.ALPHANUM)))
        {
        SetLookupMode();
        }
      else
    ...
    private void SetDependentFieldAblements(bool ablement)
      {
      TextBox_carrier_name.Enabled = ablement;
      TextBox_hostname.Enabled = ablement;
      }
    ...
    protected void Button_lookup_Click(object sender, System.EventArgs e)
      ...
      if (!PresentRecord(saved_id))
        ...
        p.biz_sms_gateways.Bind(saved_id, DropDownList_id);
    ...
    } // end TWebUserControl_sms_gateway
