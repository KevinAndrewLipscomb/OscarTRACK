...
namespace UserControl_role_privilege_mapping
{
    ...
    public partial class TWebUserControl_role_privilege_mapping: ki_web_ui.usercontrol_class
    {
        ...
        protected override void OnInit(System.EventArgs e)
        {
            ...
            InitializeComponent();
            base.OnInit(e);
            if (Session["UserControl_role_privilege_mapping.p"] != null)
            {
                p = (p_type)(Session["UserControl_role_privilege_mapping.p"]);
                p.be_loaded = IsPostBack && ((Session["M_UserControl_config_UserControl_roles_and_matrices_binder_PlaceHolder_content"] as string) == "UserControl_role_privilege_mapping");
            }
            else
            {
        ...
        private void InitializeComponent()
        {
            ...
            this.PreRender += this.TWebUserControl_role_privilege_mapping_PreRender;
        ...
        private void GridView_control_RowDataBound(object sender, System.Web.UI.WebControls.GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType != DataControlRowType.EmptyDataRow)
            {
                ...
                e.Row.Cells[Units.UserControl_role_privilege_mapping.CI_ROLE_TIER_ID].Visible = false;
...
namespace UserControl_role_privilege_mapping.Units
{
    public class UserControl_role_privilege_mapping
    {
        ...
        public const int CI_PRIVILEGE_NAME = 5;
        public const int CI_PRIVILEGE_ID = 6;
