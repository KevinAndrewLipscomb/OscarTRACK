...
begin
  ...
  +   '<tr>'
  +     '<td valign=middle>'
  +       '<img src="https://sslws010.alentus.com/frompaper2web/OscarDotNet/protected/image/vbemspatch150.jpg" height="145" width="149">'
  +     '</td>'
  +     '<td valign=middle>'
  +       '<img src="https://sslws010.alentus.com/frompaper2web/OscarDotNet/protected/image/vbemslogosmall.jpg" height="127" width="500">'
  +     '</td>'
  +     '<td valign=middle>'
  +       '<img src="https://sslws010.alentus.com/frompaper2web/OscarDotNet/protected/image/cityseal150.jpg" height="138" width="139">'
  +     '</td>'
  +   '</tr>'
  + '</table>'
