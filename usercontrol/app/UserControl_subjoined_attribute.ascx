<%@ Control Language="c#" AutoEventWireup="True" Codebehind="UserControl_subjoined_attribute.ascx.cs" Inherits="UserControl_subjoined_attribute.TWebUserControl_subjoined_attribute"%>
...
<table cellspacing="0" cellpadding="5" width="100%" border="0">
  ...
  <tr>
    <td><font class="">Time&nbsp;implemented:</font></td>
    <td>
      <font class="">
        <ASP:TextBox id="TextBox_time_implemented" runat="server"  cssclass="" enabled="False"></ASP:TextBox>
      </font>
    </td>
    <td nowrap="nowrap">
      <ASP:RequiredFieldValidator id="RequiredFieldValidator_time_implemented" runat="server" errormessage="Please enter Time&nbsp;implemented." font-bold="True" controltovalidate="TextBox_time_implemented">!ERR!</ASP:RequiredFieldValidator>
    </td>
  </tr>
  <tr>
    <td><font class="">Involvement&nbsp;id:</font></td>
    <td>
      <font class="">
        <ASP:TextBox id="TextBox_involvement_id" runat="server"  cssclass="" enabled="False"></ASP:TextBox>
      </font>
    </td>
    <td nowrap="nowrap">
      <ASP:RequiredFieldValidator id="RequiredFieldValidator_involvement_id" runat="server" errormessage="Please enter Involvement&nbsp;id." font-bold="True" controltovalidate="TextBox_involvement_id">!ERR!</ASP:RequiredFieldValidator>
      <ASP:RegularExpressionValidator id="RegularExpressionValidator_involvement_id" runat="server" errormessage="Please enter a valid Involvement&nbsp;id." font-bold="True" controltovalidate="TextBox_involvement_id" validationexpression="-?\d+">!ERR!</ASP:RegularExpressionValidator>
    </td>
  </tr>
  <tr>
