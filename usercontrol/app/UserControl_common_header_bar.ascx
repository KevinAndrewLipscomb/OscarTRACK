<%@ Control Language="c#" AutoEventWireup="false" Codebehind="UserControl_common_header_bar.pas" Inherits="UserControl_common_header_bar.TWebUserControl_common_header_bar"%>
