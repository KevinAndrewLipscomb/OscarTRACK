<%@ Control Language="c#" AutoEventWireup="True" Codebehind="UserControl_patient_age_unit.ascx.cs" Inherits="UserControl_patient_age_unit.TWebUserControl_patient_age_unit"%>
            ...
            <font class="compact">
              <table cellspacing="0" cellpadding="0" width="100%" border="0">
                <tr>
                  ...
                  <td valign="middle">
                    <small>
                      <ASP:LinkButton id="LinkButton_new_record" runat="server" causesvalidation="False" visible="False" onclick="LinkButton_new_record_Click">Enter brand new patient_age_unit
</ASP:LinkButton>
                    </small>
                  </td>
                </tr>
