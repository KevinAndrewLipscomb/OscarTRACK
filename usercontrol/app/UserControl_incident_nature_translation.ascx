<%@ Control Language="c#" AutoEventWireup="True" Codebehind="UserControl_incident_nature_translation.ascx.cs" Inherits="UserControl_incident_nature_translation.TWebUserControl_incident_nature_translation"%>
...
<table cellspacing="0" cellpadding="5" width="100%" border="0">
  ...
  <tr>
    <td><font class="">Foreign:</font></td>
    <td>
      <font class="">
        <ASP:TextBox id="TextBox_foreign" runat="server" columns="63" maxlength="63" cssclass="" enabled="False"></ASP:TextBox>
      </font>
    </td>
    <td nowrap="nowrap">
      <ASP:RequiredFieldValidator id="RequiredFieldValidator_foreign" runat="server" errormessage="Please enter Foreign." font-bold="True" controltovalidate="TextBox_foreign">!ERR!</ASP:RequiredFieldValidator>
    </td>
  </tr>
  <tr>
    <td><font class="">Local:</font></td>
    <td>
      <font class="">
        <ASP:TextBox id="TextBox_local" runat="server" columns="63" maxlength="63" cssclass="" enabled="False"></ASP:TextBox>
      </font>
    </td>
    <td nowrap="nowrap">
      <ASP:RequiredFieldValidator id="RequiredFieldValidator_local" runat="server" errormessage="Please enter Local." font-bold="True" controltovalidate="TextBox_local">!ERR!</ASP:RequiredFieldValidator>
    </td>
  </tr>
      </table>
    </td>
