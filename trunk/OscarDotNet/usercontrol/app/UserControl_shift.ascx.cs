...
namespace UserControl_shift
  {
  public partial class TWebUserControl_shift: ki_web_ui.usercontrol_class
    {
    private p_type p;
    ...
    protected void Page_Load(object sender, System.EventArgs e)
      ...
      if (!p.be_loaded)
        {
        LinkButton_new_record.Visible = p.be_ok_to_config_shifts;
        LinkButton_go_to_match_first.Text = k.ExpandTildePath(LinkButton_go_to_match_first.Text);
        LinkButton_go_to_match_prior.Text = k.ExpandTildePath(LinkButton_go_to_match_prior.Text);
        LinkButton_go_to_match_next.Text = k.ExpandTildePath(LinkButton_go_to_match_next.Text);
        LinkButton_go_to_match_last.Text = k.ExpandTildePath(LinkButton_go_to_match_last.Text);
        RequireConfirmation(Button_delete, "Are you sure you want to delete this record?");
        if ((Session["mode:goto"] != null) && Session["mode:goto"].ToString().Contains("/shift/"))
          {
    ...
    private bool PresentRecord(string id)
      ...
      if
        ...
        Button_delete.Enabled = p.be_ok_to_config_shifts;
        result = true;
        }
      return result;
      }
    ...
    protected override void OnInit(System.EventArgs e)
      ...
      if (Session["UserControl_shift.p"] != null)
        ...
        p.be_ok_to_config_shifts = k.Has((string[])(Session["privilege_array"]), "config-shifts");
        }
      }
    ...
    protected void Button_submit_Click(object sender, System.EventArgs e)
      ...
      if (Page.IsValid)
        {
        var start_time = DateTime.Parse(k.Safe(TextBox_start.Text,k.safe_hint_type.DATE_TIME));
        var end_time = DateTime.Parse(k.Safe(TextBox_end.Text,k.safe_hint_type.DATE_TIME));
        p.biz_shifts.Set
          (
    ...
    protected void Button_delete_Click(object sender, System.EventArgs e)
      {
      if (p.biz_shifts.Delete(k.Safe(TextBox_id.Text, k.safe_hint_type.ALPHANUM)))
        {
        SetLookupMode();
        }
      else
    ...
    protected void Button_lookup_Click(object sender, System.EventArgs e)
      ...
      if (!PresentRecord(saved_id))
        ...
        p.biz_shifts.Bind(saved_id, DropDownList_id);
