<%@ Control Language="c#" AutoEventWireup="True" Codebehind="UserControl_schedule_binder.ascx.cs" Inherits="UserControl_schedule_binder.TWebUserControl_schedule_binder"%>
