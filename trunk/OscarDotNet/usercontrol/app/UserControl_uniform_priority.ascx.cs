...
#warning Revise the binder-related instance_id to this control appropriately.
        if (instance_id == "ASP.protected_overview_aspx.UserControl_member_binder_uniform_priority")
          {
#warning Revise the ClientID path to this control appropriately.
          p.be_loaded &= ((Session["UserControl_member_binder_PlaceHolder_content"] as string) == "UserControl_uniform_priority");
          }
...
//        }
        ...
        //
        p.be_loaded = false;
        p.be_ok_to_config_uniform_priorities = k.Has((string[])(Session["privilege_array"]), "config-uniform_priorities");
        p.id = k.EMPTY;
        p.summary = null;
        }
      }
