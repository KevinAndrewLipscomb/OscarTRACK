...
<p><img id="Img_core_ops_size" runat="server" width="781" height="417" src='http://localhost/oscardotnet/serial_indicator_control_chart.aspx?indicator=core_ops_size' /></p>
<p>&nbsp;</p>
<p><b>2. Number of recruits and trainees in the pipeline:
</b></p>
<p><img id="Img_num_members_in_pipeline" runat="server" width="781" height="417" src='http://localhost/oscardotnet/serial_indicator_control_chart.aspx?indicator=num_members_in_pipeline' /></p>
<p>&nbsp;</p>
<p><b>3. Potential number of ambulance crew-shifts that could have been supplied on the schedule:
</b></p>
<p><img id="Img_crew_shifts_forecast" runat="server" width="781" height="417" src='http://localhost/oscardotnet/serial_indicator_control_chart.aspx?indicator=crew_shifts_forecast' /></p>
<p>&nbsp;</p>
...
<p><img id="Img_utilization" runat="server" width="781" height="417" src='http://localhost/oscardotnet/serial_indicator_control_chart.aspx?indicator=utilization' /></p>
<p>&nbsp;</p>
...
<p><img id="Img_standard_enrollment" runat="server" width="781" height="417" src='http://localhost/oscardotnet/serial_indicator_control_chart.aspx?indicator=standard_enrollment' /></p>
<p>&nbsp;</p>
...
<p><img id="Img_median_length_of_service" runat="server" width="781" height="417" src='http://localhost/oscardotnet/serial_indicator_control_chart.aspx?indicator=median_length_of_service' /></p>
<p>&nbsp;</p>
...
<p><img id="Img_commensuration" runat="server" width="781" height="417" src='http://localhost/oscardotnet/serial_indicator_control_chart.aspx?indicator=commensuration' /></p>
<p>&nbsp;</p>
<p>-- END --</p>
	</form>
  </body>
