unit report_monthly_applicant_roster;
...
type
  p_type =
    ...
    member_id: string;
    END;
  TWebForm_report_monthly_applicant_roster = class(System.Web.UI.Page)
...
/// </summary>
procedure TWebForm_report_monthly_applicant_roster.InitializeComponent;
begin
  Include(Self.Load, Self.Page_Load);
end;
{$ENDREGION}

procedure TWebForm_report_monthly_applicant_roster.Page_Load(sender: System.Object; e: System.EventArgs);
var
  url: string;
begin
  //
  Title.InnerText := ConfigurationSettings.AppSettings['application_name'] + ' - report_monthly_applicant_roster';
...
procedure TWebForm_report_monthly_applicant_roster.OnInit(e: EventArgs);
var
...
begin
  ...
  session.Add('mode:report/monthly-applicant-roster',system.string.EMPTY);
  //
  if request['agency'] = 'EMS' then begin
    role_name := 'Department Human Resources Officer';
...
procedure TWebForm_report_monthly_applicant_roster.Render(writer: HtmlTextWriter);
var
  sb: StringBuilder;
begin
  //
  ...
  ki.SmtpMailSend
    ...
    //subject
    'Report: Monthly Applicant Roster',
    //body
    sb.tostring,
    //be_html
    TRUE
