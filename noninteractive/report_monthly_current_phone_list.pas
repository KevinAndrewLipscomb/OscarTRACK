unit report_monthly_current_phone_list;
...
type
  p_type =
    ...
    member_id: string;
    END;
  TWebForm_report_monthly_current_phone_list = class(System.Web.UI.Page)
...
/// </summary>
procedure TWebForm_report_monthly_current_phone_list.InitializeComponent;
begin
  Include(Self.Load, Self.Page_Load);
end;
{$ENDREGION}

procedure TWebForm_report_monthly_current_phone_list.Page_Load(sender: System.Object; e: System.EventArgs);
var
  url: string;
begin
  //
...
procedure TWebForm_report_monthly_current_phone_list.OnInit(e: EventArgs);
var
...
begin
  ...
  session.Add('mode:report/monthly-current-phone-list',EMPTY);
  //
