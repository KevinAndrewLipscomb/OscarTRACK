using Class_biz_special_events;
using kix;
using System;
using System.Web.UI;
using System.Web.UI.WebControls;

namespace UserControl_special_event
{
    // Derived from KiAspdotnetFramework/UserControl/app/UserControl~template~trivial~item.pas
    public partial class TWebUserControl_special_event: ki_web_ui.usercontrol_class
    {
        private p_type p;
      ...
      LinkButton_go_to_match_first.Visible = false;
        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            if (!p.be_loaded)
            {
                LinkButton_new_record.Visible = p.be_ok_to_config_special_events;
        ...
        Literal_match_index.Text = DropDownList_code.SelectedIndex.ToString();
            ...
            string description;
            result = false;
            if (p.biz_special_events.Get(id, out description))
            {
                TextBox_id.Text = id;
                ...
                SetDependentFieldAblements(p.be_ok_to_config_special_events);
                Button_submit.Enabled = p.be_ok_to_config_special_events;
                Button_delete.Enabled = p.be_ok_to_config_special_events;
                result = true;
            }
            return result;
        }
        ...
        private void SetLookupMode()
        {
            ...
            LinkButton_new_record.Enabled = p.be_ok_to_config_special_events;
            TextBox_id.Focus();
        }
        ...
        protected override void OnInit(System.EventArgs e)
        {
            ...
            if (Session[InstanceId() + ".p"] != null)
            {
                ...
                p.be_loaded = IsPostBack && ((Session["UserControl_member_binder_UserControl_config_UserControl_business_objects_binder_PlaceHolder_content"] as string) == "UserControl_special_event");
            }
            else
            {
                p.be_loaded = false;
                p.biz_special_events = new TClass_biz_special_events();
                p.be_ok_to_config_special_events = k.Has((string[])(Session["privilege_array"]), "config-special_events");
            }
        ...
        public TWebUserControl_special_event Fresh()
        {
            TWebUserControl_special_event result;
        ...
        protected void Button_submit_Click(object sender, System.EventArgs e)
        {
            if (Page.IsValid)
            {
                p.biz_special_events.Set(k.Safe(TextBox_id.Text, k.safe_hint_type.NUM), k.Safe(TextBox_description.Text, k.safe_hint_type.PUNCTUATED));
        ...
        {
            if (p.biz_special_events.Delete(k.Safe(TextBox_id.Text, k.safe_hint_type.ALPHANUM)))
            {
                SetLookupMode();
            }
            else
        ...
        protected void Button_lookup_Click(object sender, System.EventArgs e)
        {
            ...
            if (!PresentRecord(saved_id))
            {
                ...
                p.biz_special_events.Bind(saved_id, DropDownList_code);
