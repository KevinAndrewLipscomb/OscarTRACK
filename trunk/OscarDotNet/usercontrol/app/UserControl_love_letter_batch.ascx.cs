...
using Class_biz_love_letter_batchs;
...
namespace UserControl_love_letter_batch
  {
  public partial class TWebUserControl_love_letter_batch: ki_web_ui.usercontrol_class
    {
    ...
    private void Clear()
      ...
      TextBox_designator.Text = k.EMPTY;
      TextBox_immune_scene_visits_factor.Text = k.EMPTY;
    ...
    protected void Page_Load(object sender, System.EventArgs e)
      ...
      if (!p.be_loaded)
        {
        LinkButton_new_record.Visible = p.be_ok_to_config_love_letter_batchs;
        LinkButton_go_to_match_first.Text = k.ExpandTildePath(LinkButton_go_to_match_first.Text);
        LinkButton_go_to_match_prior.Text = k.ExpandTildePath(LinkButton_go_to_match_prior.Text);
        LinkButton_go_to_match_next.Text = k.ExpandTildePath(LinkButton_go_to_match_next.Text);
        LinkButton_go_to_match_last.Text = k.ExpandTildePath(LinkButton_go_to_match_last.Text);
        RequireConfirmation(Button_delete, "Are you sure you want to delete this record?");
#warning Remove the following line if the love_letter_batch will primarily be a reference table as opposed to a log or journal table.
        SetDataEntryMode();
        if ((Session["mode:goto"] != null) && Session["mode:goto"].ToString().Contains("/love_letter_batch/"))
          {
    ...
    private bool PresentRecord(string id)
      ...
      if
        ...
        TextBox_designator.Text = designator;
        TextBox_immune_scene_visits_factor.Text = immune_scene_visits_factor;
        Button_lookup.Enabled = false;
        Label_lookup_arrow.Enabled = false;
        Label_lookup_hint.Enabled = false;
        LinkButton_reset.Enabled = true;
        SetDependentFieldAblements(p.be_ok_to_config_love_letter_batchs);
        Button_submit.Enabled = p.be_ok_to_config_love_letter_batchs;
        Button_delete.Enabled = p.be_ok_to_config_love_letter_batchs;
        result = true;
        }
      return result;
      }
...
#warning Revise the following line if the usercontrol will not be a direct child of the member binder.
        p.be_loaded = IsPostBack && ((Session["UserControl_member_binder_PlaceHolder_content"] as string) == "UserControl_love_letter_batch");
        }
      else
        {
        p.be_loaded = false;
        p.biz_love_letter_batchs = new TClass_biz_love_letter_batchs();
        p.biz_role_member_map = new TClass_biz_role_member_map();
        p.be_ok_to_config_love_letter_batchs = k.Has((string[])(Session["privilege_array"]), "config-love_letter_batchs");
        }
      }
    ...
    public TWebUserControl_love_letter_batch Fresh()
      {
    ...
    protected void Button_submit_Click(object sender, System.EventArgs e)
      ...
      if (Page.IsValid)
        {
        p.biz_love_letter_batchs.Set
          (
          k.Safe(TextBox_id.Text,k.safe_hint_type.NUM),
#warning Safe_hint values should be tightened.
          k.Safe(TextBox_designator.Text,k.safe_hint_type.PUNCTUATED).Trim(),
          k.Safe(TextBox_immune_scene_visits_factor.Text,k.safe_hint_type.PUNCTUATED).Trim()
          );
...
#warning Review safe-hint and tighten if necessary
    ...
    protected void Button_delete_Click(object sender, System.EventArgs e)
      {
      if (p.biz_love_letter_batchs.Delete(k.Safe(TextBox_id.Text, k.safe_hint_type.ALPHANUM)))
        {
        SetLookupMode();
        }
      else
    ...
    private void SetDependentFieldAblements(bool ablement)
      {
      TextBox_designator.Enabled = ablement;
      TextBox_immune_scene_visits_factor.Enabled = ablement;
      }
    ...
    protected void Button_lookup_Click(object sender, System.EventArgs e)
      ...
      if (!PresentRecord(saved_id))
        ...
        p.biz_love_letter_batchs.Bind(saved_id, DropDownList_id);
    ...
    } // end TWebUserControl_love_letter_batch
