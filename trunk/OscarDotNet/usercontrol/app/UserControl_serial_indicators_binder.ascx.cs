...
{
  public static class UserControl_serial_indicators_binder_Static
    {
    ...
    public const int TSSI_FLEET_TRACKING_PARTICIPATION = 8;
    }
    ...
    public partial class TWebUserControl_serial_indicators_binder: ki_web_ui.usercontrol_class
    {
        ...
        protected override void OnInit(System.EventArgs e)
        {
            ...
            if (IsPostBack && (Session["UserControl_serial_indicators_binder.p"] != null) && (Session["UserControl_serial_indicators_binder.p"].GetType().Namespace == p.GetType().Namespace))
            {
                ...
                switch(p.tab_index)
                {
                    case UserControl_serial_indicators_binder_Static.TSSI_COMMENSURATION:
                        ...
                        break;
                    case UserControl_serial_indicators_binder_Static.TSSI_NUM_CORE_OPS_MEMBERS:
                        ...
                        break;
                    case UserControl_serial_indicators_binder_Static.TSSI_NUM_MEMBERS_IN_PIPELINE:
                        ...
                        break;
                    case UserControl_serial_indicators_binder_Static.TSSI_NUM_POTENTIAL_CREW_SHIFTS:
                        ...
                        break;
                    case UserControl_serial_indicators_binder_Static.TSSI_THIRD_SLOT_SATURATION:
                        ...
                        break;
                    case UserControl_serial_indicators_binder_Static.TSSI_ROSTER_UTILIZATION:
                        ...
                        break;
                    case UserControl_serial_indicators_binder_Static.TSSI_CORE_OPS_COMMITMENT:
                        ...
                        break;
                    case UserControl_serial_indicators_binder_Static.TSSI_MEDIAN_YEARS_OF_SERVICE:
                        ...
                        break;
                    case UserControl_serial_indicators_binder_Static.TSSI_FLEET_TRACKING_PARTICIPATION:
            ...
            {
                p.be_loaded = false;
                p.tab_index = UserControl_serial_indicators_binder_Static.TSSI_COMMENSURATION;
