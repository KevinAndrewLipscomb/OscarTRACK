...
namespace Class_db_uniform_piece_vendors
  ...
  public class TClass_db_uniform_piece_vendors: TClass_db
    ...
    public bool Delete(string id)
      ...
      try
        {
        using var my_sql_command = new MySqlCommand(db_trail.Saved("delete from uniform_piece_vendor where id = \"" + id + "\""), connection);
    ...
    public bool Get
      ...
      //
      Open();
      using var my_sql_command = new MySqlCommand("select * from uniform_piece_vendor where CAST(id AS CHAR) = \"" + id + "\"", connection);
      var dr = my_sql_command.ExecuteReader();
      if (dr.Read())
        {
