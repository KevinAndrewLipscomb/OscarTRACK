...
{
    public partial class TWebForm_report_monthly_test_candidate_roster: ki_web_ui.page_class
    {
    private struct p_type
    {
        ...
        {
            string url;
            Title = Server.HtmlEncode(ConfigurationManager.AppSettings["application_name"]) + " - report_monthly_test_candidate_roster";
