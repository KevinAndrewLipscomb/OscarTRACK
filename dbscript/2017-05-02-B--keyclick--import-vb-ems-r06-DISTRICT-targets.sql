...
-- --
;
insert ignore resident_import set name = 'John Taylor', address = '2408 Three Pines Ln', city = 'VIRGINIA BEACH', state = 'VA', agency = 'CVRS';
insert ignore resident_import set name = '', address = '2409 Three Pines Ln', city = 'VIRGINIA BEACH', state = 'VA', agency = 'CVRS';
insert ignore resident_import set name = 'Robert Martin', address = '2417 Three Pines Ln', city = 'VIRGINIA BEACH', state = 'VA', agency = 'CVRS';
insert ignore resident_import set name = 'Wilbur Carawan', address = '2416 Three Pines Ln', city = 'VIRGINIA BEACH', state = 'VA', agency = 'CVRS';
;
-- --
--
--
