<%@ Control Language="c#" AutoEventWireup="True" Codebehind="UserControl_city.ascx.cs" Inherits="UserControl_city.TWebUserControl_city"%>
...
<table cellspacing="0" cellpadding="5" width="100%" border="0">
  ...
  <tr>
    ...
    <td>
      <font class="">
        <ASP:DropDownList id="DropDownList_state" runat="server"  cssclass="" enabled="False"></ASP:DropDownList>
      </font>
    </td>
    <td nowrap="True">
      <ASP:RequiredFieldValidator id="RequiredFieldValidator_state" runat="server" errormessage="Please select a State." font-bold="True" controltovalidate="DropDownList_state">!ERR!</ASP:RequiredFieldValidator>
    </td>
  </tr>
      </table>
    </td>
