...
namespace UserControl_skill_rating
  {

  public partial class TWebUserControl_skill_rating: ki_web_ui.usercontrol_class
    {

    private struct p_type
      {
      public bool be_loaded;
      public bool be_ok_to_config_skill_ratings;
    ...
    protected void Page_Load(object sender, System.EventArgs e)
      ...
      if (!p.be_loaded)
        {
        LinkButton_new_record.Visible = p.be_ok_to_config_skill_ratings;
    ...
    private bool PresentRecord(string id)
      ...
      //then
        ...
        SetDependentFieldAblements(p.be_ok_to_config_skill_ratings);
        Button_submit.Enabled = p.be_ok_to_config_skill_ratings;
        Button_delete.Enabled = p.be_ok_to_config_skill_ratings;
        result = true;
        }
      return result;
      }
    ...
    private void SetLookupMode()
      ...
      LinkButton_new_record.Enabled = p.be_ok_to_config_skill_ratings;
      TextBox_id.Focus();
      }
    ...
    protected override void OnInit(System.EventArgs e)
      ...
      if (Session[InstanceId() + ".p"] != null)
        ...
        p.be_loaded = IsPostBack && ((Session["UserControl_member_binder_UserControl_config_UserControl_business_objects_binder_PlaceHolder_content"] as string) == "UserControl_skill_rating");
        }
      else
        {
        p.be_loaded = false;
        p.biz_skill_ratings = new TClass_biz_skill_ratings();
        p.be_ok_to_config_skill_ratings = k.Has((string[])(Session["privilege_array"]), "config-skill_ratings");
        }
      }
    ...
    private void InitializeComponent()
      {
      PreRender += TWebUserControl_skill_rating_PreRender;
      }

    private void TWebUserControl_skill_rating_PreRender(object sender, System.EventArgs e)
      {
      SessionSet(InstanceId() + ".p", p);
      }

    public TWebUserControl_skill_rating Fresh()
      {
    ...
    protected void Button_submit_Click(object sender, System.EventArgs e)
      ...
      if (Page.IsValid)
        {
        p.biz_skill_ratings.Set
          (
          k.Safe(TextBox_id.Text, k.safe_hint_type.NUM),
          k.Safe(TextBox_designator.Text, k.safe_hint_type.ALPHA),
          k.Safe(TextBox_description.Text, k.safe_hint_type.ALPHA_WORDS)
          );
    ...
    protected void Button_delete_Click(object sender, System.EventArgs e)
      {
      if (p.biz_skill_ratings.Delete(k.Safe(TextBox_id.Text, k.safe_hint_type.ALPHANUM)))
        {
        SetLookupMode();
        }
      else
    ...
    protected void Button_lookup_Click(object sender, System.EventArgs e)
      {
      uint num_matches;
      var saved_id = TextBox_id.Text;
      Clear();
      if (!PresentRecord(saved_id))
        {
        TextBox_id.Text = saved_id;
        p.biz_skill_ratings.Bind(saved_id, DropDownList_code);
    ...
    } // end TWebUserControl_skill_rating
