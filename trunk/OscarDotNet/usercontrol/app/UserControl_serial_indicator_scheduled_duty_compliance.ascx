  ...
  <Columns>
	<ASP:TemplateColumn>
	  <ItemTemplate>
		...
		<p>
      <asp:Image ID="Image_control" runat="server" width="781" height="417" ImageUrl=<%# string.Format("~/serial_indicator_control_chart.aspx?indicator=scheduled_duty_compliance&agency={0}&be_agency_applicable={1}",DataBinder.Eval(Container.DataItem, "id"),DataBinder.Eval(Container.DataItem, "be_agency_id_applicable")) %> AlternateText="scheduled_duty_compliance"/>
    </p>
	  </ItemTemplate>
	</ASP:TemplateColumn>
  </Columns>
