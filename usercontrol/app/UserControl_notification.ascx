<%@ Control Language="c#" AutoEventWireup="True" Codebehind="UserControl_notification.ascx.cs" Inherits="UserControl_notification.TWebUserControl_notification"%>
          ...
          <td valign="top">
            <font class="">
              ...
              <ASP:TextBox id="TextBox_name" runat="server" columns="63" maxlength="63" cssclass=""></ASP:TextBox><ASP:Button id="Button_lookup" runat="server" causesvalidation="False" text="LOOKUP" onclick="Button_lookup_Click"></ASP:Button>
                        ...
                        <td><small><small><em><asp:Label id="Label_lookup_hint" runat="server">Lookup by partial or full Notification name</asp:Label></em></small></small></td>
                      </tr>
                    </table>
                  </td>
                  <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                  ...
                  <td valign="middle">
                    <small>
                      <ASP:LinkButton id="LinkButton_new_record" runat="server" causesvalidation="False" visible="False" onclick="LinkButton_new_record_Click">Enter brand new Notification</ASP:LinkButton>
                    </small>
                  </td>
                </tr>
              </table>
      <table>
        <tr>
          ...
          <td nowrap="nowrap" valign="top">
            ...
            <asp:RegularExpressionValidator id="RegularExpressionValidator_name" runat="server" errormessage="Please enter a valid Notification title." font-bold="True" controltovalidate="TextBox_name" validationexpression="[a-zA-Z\-. ']+">!ERR!</asp:RegularExpressionValidator>
          </td>
        </tr>
        </table>
    </td>
