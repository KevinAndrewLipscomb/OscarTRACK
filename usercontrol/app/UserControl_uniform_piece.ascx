<%@ Control Language="c#" AutoEventWireup="True" Codebehind="UserControl_uniform_piece.ascx.cs" Inherits="UserControl_uniform_piece.TWebUserControl_uniform_piece"%>
...
<table cellspacing="0" cellpadding="5" width="100%" border="0">
  ...
  <tr>
    <td><font class="">Layer:</font></td>
    <td>
      <font class="">
        <ASP:TextBox id="TextBox_layer" runat="server"  cssclass="" enabled="False"></ASP:TextBox>
      </font>
    </td>
    <td nowrap="nowrap">
      <ASP:RequiredFieldValidator id="RequiredFieldValidator_layer" runat="server" errormessage="Please enter Layer." font-bold="True" controltovalidate="TextBox_layer">!ERR!</ASP:RequiredFieldValidator>
      <ASP:RegularExpressionValidator id="RegularExpressionValidator_layer" runat="server" errormessage="Please enter a valid Layer." font-bold="True" controltovalidate="TextBox_layer" validationexpression="\d*">!ERR!</ASP:RegularExpressionValidator>
    </td>
  </tr>
  <tr>
  ...
  <tr>
    <td><font class="">Authorized&nbsp;quantity:</font></td>
    <td>
      <font class="">
        <ASP:TextBox id="TextBox_authorized_quantity" runat="server"  cssclass="" enabled="False"></ASP:TextBox>
      </font>
    </td>
    <td nowrap="nowrap">
      <ASP:RegularExpressionValidator id="RegularExpressionValidator_authorized_quantity" runat="server" errormessage="Please enter a valid Authorized&nbsp;quantity." font-bold="True" controltovalidate="TextBox_authorized_quantity" validationexpression="\d*">!ERR!</ASP:RegularExpressionValidator>
    </td>
  </tr>
      </table>
    </td>
