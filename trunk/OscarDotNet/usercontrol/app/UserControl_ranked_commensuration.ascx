<%@ Control Language="c#" AutoEventWireup="false" Codebehind="UserControl_ranked_commensuration.pas" Inherits="UserControl_ranked_commensuration.TWebUserControl_ranked_commensuration"%>
