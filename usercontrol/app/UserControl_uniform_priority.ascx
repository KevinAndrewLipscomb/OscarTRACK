<%@ Control Language="c#" AutoEventWireup="True" Codebehind="UserControl_uniform_priority.ascx.cs" Inherits="UserControl_uniform_priority.TWebUserControl_uniform_priority"%>
...
<table cellspacing="0" cellpadding="5" width="100%" border="0">
  ...
  <tr>
    <td><font class="">Value:</font></td>
    <td>
      <font class="">
        <ASP:TextBox id="TextBox_value" runat="server"  cssclass="" enabled="False"></ASP:TextBox>
      </font>
    </td>
    <td nowrap="nowrap">
      <ASP:RequiredFieldValidator id="RequiredFieldValidator_value" runat="server" errormessage="Please enter Value." font-bold="True" controltovalidate="TextBox_value">!ERR!</ASP:RequiredFieldValidator>
      <ASP:RegularExpressionValidator id="RegularExpressionValidator_value" runat="server" errormessage="Please enter a valid Value." font-bold="True" controltovalidate="TextBox_value" validationexpression="\d*">!ERR!</ASP:RegularExpressionValidator>
    </td>
  </tr>
  <tr>
    ...
    <td>
      <font class="">
        <ASP:TextBox id="TextBox_description" runat="server" columns="63" maxlength="63" cssclass="" enabled="False"></ASP:TextBox>
      </font>
    </td>
    <td nowrap="nowrap">
