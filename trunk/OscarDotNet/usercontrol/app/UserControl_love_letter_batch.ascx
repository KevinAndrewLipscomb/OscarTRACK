<%@ Control Language="c#" AutoEventWireup="True" Codebehind="UserControl_love_letter_batch.ascx.cs" Inherits="UserControl_love_letter_batch.TWebUserControl_love_letter_batch"%>
...
<table cellspacing="0" cellpadding="5" width="100%" border="0">
  ...
  <tr>
    ...
    <td>
      <font class="">
        <ASP:TextBox id="TextBox_designator" runat="server" columns="9" maxlength="9" cssclass="" enabled="False"></ASP:TextBox>
      </font>
    </td>
    <td nowrap="True">
      <ASP:RequiredFieldValidator id="RequiredFieldValidator_designator" runat="server" errormessage="Please enter Designator." font-bold="True" controltovalidate="TextBox_designator">!ERR!</ASP:RequiredFieldValidator>
    </td>
  </tr>
  <tr>
    <td><font class="">Immune&nbsp;scene&nbsp;visits&nbsp;factor:</font></td>
    <td>
      <font class="">
        <ASP:TextBox id="TextBox_immune_scene_visits_factor" runat="server"  cssclass="" enabled="False"></ASP:TextBox>
      </font>
    </td>
    <td nowrap="True">
      <ASP:RegularExpressionValidator id="RegularExpressionValidator_immune_scene_visits_factor" runat="server" errormessage="Please enter a valid Immune&nbsp;scene&nbsp;visits&nbsp;factor." font-bold="True" controltovalidate="TextBox_immune_scene_visits_factor" validationexpression="\d*\.?\d*">!ERR!</ASP:RegularExpressionValidator>
    </td>
  </tr>
      </table>
    </td>
