...
namespace Class_db_patient_encounter_levels
  {

  internal enum patient_encounter_level_enumeration
    {
    DESCRIPTION_1 = 1,
    DESCRIPTION_2 = 2
    }
  ...
  public class TClass_db_patient_encounter_levels: TClass_db
    ...
    public void Set
      ...
      using var my_sql_command = new MySqlCommand
        ...
        db_trail.Saved
          (
          "insert patient_encounter_level"
          + " set id = NULLIF('" + id + "','')"
    ...
    } // end TClass_db_patient_encounter_levels
