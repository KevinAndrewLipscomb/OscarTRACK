    ...
    public partial class TWebUserControl_patient_age_unit: ki_web_ui.usercontrol_class
    {
      ...
      LinkButton_go_to_match_first.Visible = false;
        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            if (!p.be_loaded)
            {
                LinkButton_new_record.Visible = p.be_ok_to_config_patient_age_units;
        ...
        Literal_match_index.Text = DropDownList_code.SelectedIndex.ToString();
            ...
            string description;
            result = false;
            if (p.biz_patient_age_units.Get(id, out description))
            {
                TextBox_id.Text = id;
                ...
                SetDependentFieldAblements(p.be_ok_to_config_patient_age_units);
                Button_submit.Enabled = p.be_ok_to_config_patient_age_units;
                Button_delete.Enabled = p.be_ok_to_config_patient_age_units;
                result = true;
            }
            return result;
        }
        ...
        private void SetLookupMode()
        {
            ...
            LinkButton_new_record.Enabled = p.be_ok_to_config_patient_age_units;
            TextBox_id.Focus();
        }
        ...
        protected override void OnInit(System.EventArgs e)
        {
            ...
            if (Session[InstanceId() + ".p"] != null)
            {
                ...
                p.be_loaded = IsPostBack && ((Session["UserControl_member_binder_UserControl_config_UserControl_business_objects_binder_PlaceHolder_content"] as string) == "UserControl_patient_age_unit");
            }
            else
            {
                p.be_loaded = false;
                p.biz_patient_age_units = new TClass_biz_patient_age_units();
                p.be_ok_to_config_patient_age_units = k.Has((string[])(Session["privilege_array"]), "config-patient_age_units");
            }
        ...
        public TWebUserControl_patient_age_unit Fresh()
        {
            TWebUserControl_patient_age_unit result;
        ...
        protected void Button_submit_Click(object sender, System.EventArgs e)
        {
            if (Page.IsValid)
            {
                p.biz_patient_age_units.Set(k.Safe(TextBox_id.Text, k.safe_hint_type.NUM), k.Safe(TextBox_description.Text, k.safe_hint_type.PUNCTUATED));
        ...
        {
            if (p.biz_patient_age_units.Delete(k.Safe(TextBox_id.Text, k.safe_hint_type.ALPHANUM)))
            {
                SetLookupMode();
            }
            else
        ...
        protected void Button_lookup_Click(object sender, System.EventArgs e)
        {
            ...
            if (!PresentRecord(saved_id))
            {
                ...
                p.biz_patient_age_units.Bind(saved_id, DropDownList_code);
