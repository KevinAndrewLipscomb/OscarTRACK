<%@ Control Language="c#" AutoEventWireup="True" Codebehind="UserControl_sms_gateway.ascx.cs" Inherits="UserControl_sms_gateway.TWebUserControl_sms_gateway"%>
...
<table cellspacing="0" cellpadding="5" width="100%" border="0">
  ...
  <tr>
    <td><font class="">Carrier&nbsp;name:</font></td>
    <td>
      <font class="">
        <ASP:TextBox id="TextBox_carrier_name" runat="server" columns="63" maxlength="63" cssclass="" enabled="False"></ASP:TextBox>
      </font>
    </td>
    <td nowrap="nowrap">
      <ASP:RequiredFieldValidator id="RequiredFieldValidator_carrier_name" runat="server" errormessage="Please enter Carrier&nbsp;name." font-bold="True" controltovalidate="TextBox_carrier_name">!ERR!</ASP:RequiredFieldValidator>
    </td>
  </tr>
  <tr>
    <td><font class="">Hostname:</font></td>
    <td>
      <font class="">
        <ASP:TextBox id="TextBox_hostname" runat="server" columns="72" maxlength="253" cssclass="" enabled="False"></ASP:TextBox>
      </font>
    </td>
    <td nowrap="nowrap">
      <ASP:RequiredFieldValidator id="RequiredFieldValidator_hostname" runat="server" errormessage="Please enter Hostname." font-bold="True" controltovalidate="TextBox_hostname">!ERR!</ASP:RequiredFieldValidator>
    </td>
  </tr>
      </table>
    </td>
