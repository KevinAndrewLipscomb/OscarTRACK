<%@ Control Language="c#" AutoEventWireup="True" Codebehind="UserControl_uniform_class.ascx.cs" Inherits="UserControl_uniform_class.TWebUserControl_uniform_class"%>
...
<table cellspacing="0" cellpadding="5" width="100%" border="0">
  ...
  <tr>
    ...
    <td>
      <font class="">
        <ASP:TextBox id="TextBox_short_designator" runat="server" columns="1" maxlength="1" cssclass="" enabled="False"></ASP:TextBox>
      </font>
    </td>
    <td nowrap="nowrap">
      <ASP:RequiredFieldValidator id="RequiredFieldValidator_short_designator" runat="server" errormessage="Please enter Short&nbsp;designator." font-bold="True" controltovalidate="TextBox_short_designator">!ERR!</ASP:RequiredFieldValidator>
    </td>
  </tr>
  <tr>
    ...
    <td>
      <font class="">
        <ASP:TextBox id="TextBox_long_designator" runat="server" columns="15" maxlength="15" cssclass="" enabled="False"></ASP:TextBox>
      </font>
    </td>
    <td nowrap="nowrap">
