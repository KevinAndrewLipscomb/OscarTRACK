...
<table cellspacing="0" cellpadding="5" width="100%" border="0">
  ...
  <tr>
    <td valign="top"><font class="">Value:</font></td>
    <td>
      <font class="">
        <ASP:TextBox id="TextBox_value" runat="server" columns="32" maxlength="32" cssclass="" enabled="False"></ASP:TextBox>
        <p>
          <small>
            One reasonable practice would be to pick four passwords generated by
            <asp:HyperLink ID="HyperLink_password_generator" runat="server" NavigateUrl="http://www.multicians.org/thvv/gpw.html" Target="_blank">Tom Van Vleck's Password Generator</asp:HyperLink>, enter them into the
            <asp:HyperLink ID="HyperLink_base64_encoder" runat="server" NavigateUrl="http://www.tools4noobs.com/online_php_functions/base64_encode/" Target="_blank">Tools 4 Noobs Online base64_encode() function</asp:HyperLink>, and use the output as the
            value.&nbsp; Only the first 32 characters will be used, but that's fine for this purpose.
          </small>
        </p>
      </font>
    </td>
