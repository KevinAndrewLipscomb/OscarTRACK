unit UserControl_ranked_standard_enrollment;
...
type
  p_type =
    ...
    total_raw: decimal;
    END;
  TWebUserControl_ranked_standard_enrollment = class(ki_web_ui.usercontrol_class)
  {$REGION 'Designer Managed Code'}
  strict private
    procedure InitializeComponent;
    procedure TWebUserControl_ranked_standard_enrollment_PreRender(sender: System.Object;
      e: System.EventArgs);
...
procedure TWebUserControl_ranked_standard_enrollment.OnInit(e: System.EventArgs);
begin
  //
...
procedure TWebUserControl_ranked_standard_enrollment.DataGrid_detail_ItemDataBound(sender: System.Object;
...
/// </summary>
procedure TWebUserControl_ranked_standard_enrollment.InitializeComponent;
begin
  Include(Self.DataGrid_detail.ItemDataBound, Self.DataGrid_detail_ItemDataBound);
  Include(Self.Load, Self.Page_Load);
  Include(Self.PreRender, Self.TWebUserControl_ranked_standard_enrollment_PreRender);
end;
{$ENDREGION}
