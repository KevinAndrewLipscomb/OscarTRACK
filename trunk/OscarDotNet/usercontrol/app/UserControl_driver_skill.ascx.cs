...
namespace UserControl_driver_skill
{
    public partial class TWebUserControl_driver_skill: ki_web_ui.usercontrol_class
    {

        private struct p_type
        {
            public bool be_loaded;
            public bool be_ok_to_config_driver_skills;
      ...
      LinkButton_go_to_match_first.Visible = false;
        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            if (!p.be_loaded)
            {
                LinkButton_new_record.Visible = p.be_ok_to_config_driver_skills;
        ...
        Literal_match_index.Text = DropDownList_code.SelectedIndex.ToString();
            ...
            string description;
            result = false;
            if (p.biz_driver_skills.Get(id, out description))
            {
                TextBox_id.Text = id;
                ...
                SetDependentFieldAblements(p.be_ok_to_config_driver_skills);
                Button_submit.Enabled = p.be_ok_to_config_driver_skills;
                Button_delete.Enabled = p.be_ok_to_config_driver_skills;
                result = true;
            }
            return result;
        }
        ...
        private void SetLookupMode()
        {
            ...
            LinkButton_new_record.Enabled = p.be_ok_to_config_driver_skills;
            TextBox_id.Focus();
        }
        ...
        protected override void OnInit(System.EventArgs e)
        {
            ...
            if (Session[InstanceId() + ".p"] != null)
            {
                ...
                p.be_loaded = IsPostBack && ((Session["UserControl_member_binder_UserControl_config_UserControl_business_objects_binder_PlaceHolder_content"] as string) == "UserControl_driver_skill");
            }
            else
            {
                p.be_loaded = false;
                p.biz_driver_skills = new TClass_biz_driver_skills();
                p.be_ok_to_config_driver_skills = k.Has((string[])(Session["privilege_array"]), "config-driver_skills");
            }
        ...
        public TWebUserControl_driver_skill Fresh()
        {
            TWebUserControl_driver_skill result;
        ...
        protected void Button_submit_Click(object sender, System.EventArgs e)
        {
            if (Page.IsValid)
            {
                p.biz_driver_skills.Set(k.Safe(TextBox_id.Text, k.safe_hint_type.NUM), k.Safe(TextBox_description.Text, k.safe_hint_type.PUNCTUATED));
        ...
        {
            if (p.biz_driver_skills.Delete(k.Safe(TextBox_id.Text, k.safe_hint_type.ALPHANUM)))
            {
                SetLookupMode();
            }
            else
        ...
        protected void Button_lookup_Click(object sender, System.EventArgs e)
        {
            ...
            if (!PresentRecord(saved_id))
            {
                ...
                p.biz_driver_skills.Bind(saved_id, DropDownList_code);
    ...
    } // end TWebUserControl_driver_skill
