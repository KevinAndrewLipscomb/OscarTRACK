...
namespace Class_db_special_events
  ...
  public class TClass_db_special_events: TClass_db
    ...
    public void BindDirectToListControl
      ...
      Open();
      var dr = new MySqlCommand("SELECT id,description FROM special_event where description <> '(none specified)' order by id", connection).ExecuteReader();
      while (dr.Read())
        {
    ...
    public bool Delete(string id)
      ...
      try
        {
        new MySqlCommand(db_trail.Saved("delete from special_event where id = '" + id + "'"), connection).ExecuteNonQuery();
        }
    ...
    public bool Get
      ...
      var result = false;
      Open();
      var dr = new MySqlCommand("select description from special_event where id = '" + id + "'", connection).ExecuteReader();
      if (dr.Read())
        {
