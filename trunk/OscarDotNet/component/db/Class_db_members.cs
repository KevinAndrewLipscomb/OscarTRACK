...
namespace Class_db_members
{
    ...
    private string CombinedBaseObligationExpression()
      {
      return new StringBuilder()
        .Append(" (")
        .Append(  " (")
        .Append(  "   IFNULL(" + MonthBaseObligationSubquery("month_10_ago_code") + ",0)")
        .Append(  " +")
        .Append(  "   IFNULL(" + MonthBaseObligationSubquery("month_9_ago_code") + ",0)")
        .Append(  " +")
        .Append(  "   IFNULL(" + MonthBaseObligationSubquery("month_8_ago_code") + ",0)")
        .Append(  " +")
        .Append(  "   IFNULL(" + MonthBaseObligationSubquery("month_7_ago_code") + ",0)")
        .Append(  " +")
        .Append(  "   IFNULL(" + MonthBaseObligationSubquery("month_6_ago_code") + ",0)")
        .Append(  " +")
        .Append(  "   IFNULL(" + MonthBaseObligationSubquery("month_5_ago_code") + ",0)")
        .Append(  " +")
        .Append(  "   IFNULL(" + MonthBaseObligationSubquery("month_4_ago_code") + ",0)")
        .Append(  " +")
        .Append(  "   IFNULL(" + MonthBaseObligationSubquery("month_3_ago_code") + ",0)")
        .Append(  " +")
        .Append(  "   IFNULL(" + MonthBaseObligationSubquery("month_2_ago_code") + ",0)")
        .Append(  " +")
        .Append(  "   IFNULL(" + MonthBaseObligationSubquery("month_1_ago_code") + ",0)")
        .Append(  " )")
        .Append(" *")
        .Append(  " 12")
        .Append(" )")
    ...
    private string MonthLevelCodeSubquery
      ...
      return new StringBuilder()
        ...
        .Append(  " and DATE_FORMAT(ADDDATE(CURDATE(),INTERVAL " + relative_month_num_string + " MONTH),'%Y-%m-15') between start_date and IFNULL(end_date,'9999-12-31')")
        .Append(" limit 1")
        .Append(" )")
        .ToString();
      }
    ...
    internal void BindActivityLookbackBaseDataList
      ...
      var sql = new StringBuilder()
        ...
        .Append(" , " + PercentageExpression(MonthDutyHoursSubquery("-10"),"(" + MonthBaseObligationSubquery("month_10_ago_code") + "*12)") + " as month_10_ago_pct_of_base")
        ...
        .Append(" , FORMAT(IFNULL(" + MonthBaseObligationSubquery("month_9_ago_code") + "*12,0),1) as month_9_ago_base_obligation")
        .Append(" , " + PercentageExpression(MonthDutyHoursSubquery("-9"),"(" + MonthBaseObligationSubquery("month_9_ago_code") + "*12)") + "month_9_ago_pct_of_base")
        ...
        .Append(" , FORMAT(IFNULL(" + MonthBaseObligationSubquery("month_8_ago_code") + "*12,0),1) as month_8_ago_base_obligation")
        .Append(" , " + PercentageExpression(MonthDutyHoursSubquery("-8"),"(" + MonthBaseObligationSubquery("month_8_ago_code") + "*12)") + "month_8_ago_pct_of_base")
        ...
        .Append(" , FORMAT(IFNULL(" + MonthBaseObligationSubquery("month_7_ago_code") + "*12,0),1) as month_7_ago_base_obligation")
        .Append(" , " + PercentageExpression(MonthDutyHoursSubquery("-7"),"(" + MonthBaseObligationSubquery("month_7_ago_code") + "*12)") + "month_7_ago_pct_of_base")
        ...
        .Append(" , FORMAT(IFNULL(" + MonthBaseObligationSubquery("month_6_ago_code") + "*12,0),1) as month_6_ago_base_obligation")
        .Append(" , " + PercentageExpression(MonthDutyHoursSubquery("-6"),"(" + MonthBaseObligationSubquery("month_6_ago_code") + "*12)") + "month_6_ago_pct_of_base")
        ...
        .Append(" , FORMAT(IFNULL(" + MonthBaseObligationSubquery("month_5_ago_code") + "*12,0),1) as month_5_ago_base_obligation")
        .Append(" , " + PercentageExpression(MonthDutyHoursSubquery("-5"),"(" + MonthBaseObligationSubquery("month_5_ago_code") + "*12)") + "month_5_ago_pct_of_base")
        ...
        .Append(" , FORMAT(IFNULL(" + MonthBaseObligationSubquery("month_4_ago_code") + "*12,0),1) as month_4_ago_base_obligation")
        .Append(" , " + PercentageExpression(MonthDutyHoursSubquery("-4"),"(" + MonthBaseObligationSubquery("month_4_ago_code") + "*12)") + "month_4_ago_pct_of_base")
        ...
        .Append(" , FORMAT(IFNULL(" + MonthBaseObligationSubquery("month_3_ago_code") + "*12,0),1) as month_3_ago_base_obligation")
        .Append(" , " + PercentageExpression(MonthDutyHoursSubquery("-3"),"(" + MonthBaseObligationSubquery("month_3_ago_code") + "*12)") + "month_3_ago_pct_of_base")
        ...
        .Append(" , FORMAT(IFNULL(" + MonthBaseObligationSubquery("month_2_ago_code") + "*12,0),1) as month_2_ago_base_obligation")
        .Append(" , " + PercentageExpression(MonthDutyHoursSubquery("-2"),"(" + MonthBaseObligationSubquery("month_2_ago_code") + "*12)") + "month_2_ago_pct_of_base")
        ...
        .Append(" , FORMAT(IFNULL(" + MonthBaseObligationSubquery("month_1_ago_code") + "*12,0),1) as month_1_ago_base_obligation")
        .Append(" , " + PercentageExpression(MonthDutyHoursSubquery("-1"),"(" + MonthBaseObligationSubquery("month_1_ago_code") + "*12)") + "month_1_ago_pct_of_base")
        ...
        .Append(  " or " + RelevantLevelCondition("month_6_ago_code"))
        .Append(  " or " + RelevantLevelCondition("month_5_ago_code"))
        .Append(  " or " + RelevantLevelCondition("month_4_ago_code"))
        .Append(  " or " + RelevantLevelCondition("month_3_ago_code"))
        .Append(  " or " + RelevantLevelCondition("month_2_ago_code"))
