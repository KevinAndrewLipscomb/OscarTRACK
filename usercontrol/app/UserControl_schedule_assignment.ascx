<%@ Control Language="c#" AutoEventWireup="True" Codebehind="UserControl_schedule_assignment.ascx.cs" Inherits="UserControl_schedule_assignment.TWebUserControl_schedule_assignment"%>
...
<table cellspacing="0" cellpadding="5" width="100%" border="0">
  ...
  <tr>
    <td><font class="">Nominal day:</font></td>
    <td>
      <font class="">
        <uc1:UserControl_drop_down_date id="UserControl_drop_down_date_nominal_day" runat="server"  cssclass=""></uc1:UserControl_drop_down_date>
      </font>
    </td>
    <td nowrap="True">
    </td>
  ...
  <tr>
    <td><font class="">Shift id:</font></td>
    <td>
      <font class="">
        <ASP:TextBox id="TextBox_shift_id" runat="server"  cssclass="" enabled="False"></ASP:TextBox>
      </font>
    </td>
    <td nowrap="True">
      <ASP:RequiredFieldValidator id="RequiredFieldValidator_shift_id" runat="server" errormessage="Please enter Shift id." font-bold="True" controltovalidate="TextBox_shift_id">!ERR!</ASP:RequiredFieldValidator>
      <ASP:RegularExpressionValidator id="RegularExpressionValidator_shift_id" runat="server" errormessage="Please enter a valid Shift id." font-bold="True" controltovalidate="TextBox_shift_id" validationexpression="-?\d+">!ERR!</ASP:RegularExpressionValidator>
    </td>
  </tr>
  <tr>
    <td><font class="">Post id:</font></td>
    <td>
      <font class="">
        <ASP:TextBox id="TextBox_post_id" runat="server"  cssclass="" enabled="False"></ASP:TextBox>
      </font>
    </td>
    <td nowrap="True">
      <ASP:RequiredFieldValidator id="RequiredFieldValidator_post_id" runat="server" errormessage="Please enter Post id." font-bold="True" controltovalidate="TextBox_post_id">!ERR!</ASP:RequiredFieldValidator>
      <ASP:RegularExpressionValidator id="RegularExpressionValidator_post_id" runat="server" errormessage="Please enter a valid Post id." font-bold="True" controltovalidate="TextBox_post_id" validationexpression="-?\d+">!ERR!</ASP:RegularExpressionValidator>
    </td>
  </tr>
  <tr>
    <td><font class="">Post cardinality:</font></td>
    <td>
      <font class="">
        <ASP:TextBox id="TextBox_post_cardinality" runat="server"  cssclass="" enabled="False"></ASP:TextBox>
      </font>
    </td>
    <td nowrap="True">
      <ASP:RequiredFieldValidator id="RequiredFieldValidator_post_cardinality" runat="server" errormessage="Please enter Post cardinality." font-bold="True" controltovalidate="TextBox_post_cardinality">!ERR!</ASP:RequiredFieldValidator>
      <ASP:RegularExpressionValidator id="RegularExpressionValidator_post_cardinality" runat="server" errormessage="Please enter a valid Post cardinality." font-bold="True" controltovalidate="TextBox_post_cardinality" validationexpression="\d*">!ERR!</ASP:RegularExpressionValidator>
    </td>
  </tr>
  <tr>
    <td><font class="">Position id:</font></td>
    <td>
      <font class="">
        <ASP:TextBox id="TextBox_position_id" runat="server"  cssclass="" enabled="False"></ASP:TextBox>
      </font>
    </td>
    <td nowrap="True">
      <ASP:RegularExpressionValidator id="RegularExpressionValidator_position_id" runat="server" errormessage="Please enter a valid Position id." font-bold="True" controltovalidate="TextBox_position_id" validationexpression="-?\d+">!ERR!</ASP:RegularExpressionValidator>
    </td>
  </tr>
  <tr>
  ...
  <tr>
    <td><font class="">Be selected:</font></td>
    <td>
      <font class="">
        <ASP:CheckBox id="CheckBox_be_selected" runat="server"  cssclass="" enabled="False"></ASP:CheckBox>
      </font>
    </td>
    <td nowrap="True">
    </td>
  ...
  <tr>
    <td><font class="">Comment:</font></td>
    <td>
      <font class="">
        <ASP:TextBox id="TextBox_comment" runat="server" columns="72" maxlength="511" cssclass="" enabled="False"></ASP:TextBox>
      </font>
    </td>
    <td nowrap="True">
    </td>
