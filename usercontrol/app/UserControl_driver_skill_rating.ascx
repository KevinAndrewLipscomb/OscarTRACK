<%@ Control Language="c#" AutoEventWireup="True" Codebehind="UserControl_driver_skill_rating.ascx.cs" Inherits="UserControl_driver_skill_rating.TWebUserControl_driver_skill_rating"%>
...
<table cellspacing="0" cellpadding="5" width="100%" border="0">
  ...
  <tr>
    <td><font class="">Driver&nbsp;skill&nbsp;id:</font></td>
    <td>
      <font class="">
        <ASP:TextBox id="TextBox_driver_skill_id" runat="server"  cssclass="" enabled="False"></ASP:TextBox>
      </font>
    </td>
    <td nowrap="True">
      <ASP:RequiredFieldValidator id="RequiredFieldValidator_driver_skill_id" runat="server" errormessage="Please enter Driver&nbsp;skill&nbsp;id." font-bold="True" controltovalidate="TextBox_driver_skill_id">!ERR!</ASP:RequiredFieldValidator>
      <ASP:RegularExpressionValidator id="RegularExpressionValidator_driver_skill_id" runat="server" errormessage="Please enter a valid Driver&nbsp;skill&nbsp;id." font-bold="True" controltovalidate="TextBox_driver_skill_id" validationexpression="-?\d+">!ERR!</ASP:RegularExpressionValidator>
    </td>
  </tr>
  <tr>
  ...
  <tr>
    <td><font class="">Eval&nbsp;id:</font></td>
    <td>
      <font class="">
        <ASP:TextBox id="TextBox_eval_id" runat="server"  cssclass="" enabled="False"></ASP:TextBox>
      </font>
    </td>
    <td nowrap="True">
      <ASP:RequiredFieldValidator id="RequiredFieldValidator_eval_id" runat="server" errormessage="Please enter Eval&nbsp;id." font-bold="True" controltovalidate="TextBox_eval_id">!ERR!</ASP:RequiredFieldValidator>
      <ASP:RegularExpressionValidator id="RegularExpressionValidator_eval_id" runat="server" errormessage="Please enter a valid Eval&nbsp;id." font-bold="True" controltovalidate="TextBox_eval_id" validationexpression="-?\d+">!ERR!</ASP:RegularExpressionValidator>
    </td>
  </tr>
      </table>
    </td>
