...
using appcommon;
namespace UserControl_serial_indicator_third_slot_saturation
{
    ...
    public partial class TWebUserControl_serial_indicator_third_slot_saturation: ki_web_ui.usercontrol_class
    {
        private p_type p;
        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            if (!p.be_loaded)
            {
                p.biz_agencies.BindForControlCharts("third_slot_saturation", DataGrid_control_charts);
                p.be_loaded = true;
            }
    ...
    } // end TWebUserControl_serial_indicator_third_slot_saturation
