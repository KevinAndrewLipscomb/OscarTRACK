...
namespace UserControl_capcode_unit_map
  {
  public partial class TWebUserControl_capcode_unit_map: ki_web_ui.usercontrol_class
    {
    private struct p_type
      {
      public bool be_loaded;
      public TClass_biz_capcode_unit_maps biz_capcode_unit_maps;
      public TClass_biz_role_member_map biz_role_member_map;
      public bool be_ok_to_config_capcode_unit_maps;
      public string id;
    ...
    protected void Page_Load(object sender, System.EventArgs e)
      ...
      if (!p.be_loaded)
        {
        LinkButton_new_record.Visible = p.be_ok_to_config_capcode_unit_maps;
    ...
    private bool PresentRecord(string id)
      ...
      if
        ...
        SetDependentFieldAblements(p.be_ok_to_config_capcode_unit_maps);
        Button_submit.Enabled = p.be_ok_to_config_capcode_unit_maps;
        Button_delete.Enabled = p.be_ok_to_config_capcode_unit_maps;
        result = true;
        }
      return result;
      }
    ...
    protected override void OnInit(System.EventArgs e)
      ...
      if (Session[instance_id + ".p"] != null)
        ...
        if (instance_id == "ASP.protected_overview_aspx.UserControl_M_config_business_objects_binder_cad_object_binder_incident_nature")
          {
          p.be_loaded &= ((Session["M_UserControl_config_UserControl_business_objects_binder_UserControl_cad_object_binder_PlaceHolder_content"] as string) == "UserControl_capcode_unit_map");
          }
//      else if (instance_id == "ASP.~_aspx.UserControl_~_binder_capcode_unit_map")
//        {
//        p.be_loaded &= ((Session["UserControl_~_binder_PlaceHolder_content"] as string) == "UserControl_capcode_unit_map");
//        }
        }
      else
        {
        p.biz_capcode_unit_maps = new TClass_biz_capcode_unit_maps();
        p.biz_role_member_map = new TClass_biz_role_member_map();
        //
        p.be_loaded = false;
        p.be_ok_to_config_capcode_unit_maps = k.Has((string[])(Session["privilege_array"]), "config-capcode-unit-maps");
        p.id = k.EMPTY;
        p.summary = null;
        }
      }
    ...
    private void InitializeComponent()
      {
      PreRender += TWebUserControl_capcode_unit_map_PreRender;
      }

    private void TWebUserControl_capcode_unit_map_PreRender(object sender, System.EventArgs e)
      {
      SessionSet(InstanceId() + ".p", p);
      }

    public TWebUserControl_capcode_unit_map Fresh()
      {
    ...
    protected void Button_submit_Click(object sender, System.EventArgs e)
      ...
      if (Page.IsValid)
        ...
        p.biz_capcode_unit_maps.Set
          ...
          k.Safe(TextBox_unit.Text,k.safe_hint_type.ALPHANUM).Trim()
          );
    ...
    protected void Button_delete_Click(object sender, System.EventArgs e)
      {
      if (p.biz_capcode_unit_maps.Delete(k.Safe(TextBox_id.Text, k.safe_hint_type.ALPHANUM)))
        {
        SetLookupMode();
        }
      else
    ...
    protected void Button_lookup_Click(object sender, System.EventArgs e)
      ...
      if (!PresentRecord(saved_id))
        ...
        p.biz_capcode_unit_maps.Bind(saved_id, DropDownList_id);
    ...
    internal void SetP
      ...
      if (id.Length > 0)
        {
        p.id = id;
        p.summary = p.biz_capcode_unit_maps.Summary(id);
        //p.be_ok_to_config_capcode_unit_maps = p.biz_privileges.HasForContainer
        //  (
        //  member_id:p.biz_members.IdOfUserId(p.biz_user.IdNum()),
        //  privilege_name:"config-capcode_unit_maps",
        //  container_id:p.biz_capcode_unit_maps.ContainerIdOf(p.summary)
        //  );
        p.presentation_mode = (p.be_ok_to_config_capcode_unit_maps ? presentation_mode_enum.FULL_FUNCTION : p.presentation_mode = presentation_mode_enum.REVIEW_ONLY);
        }
      else
        {
        p.id = k.EMPTY;
    ...
    } // end TWebUserControl_capcode_unit_map
