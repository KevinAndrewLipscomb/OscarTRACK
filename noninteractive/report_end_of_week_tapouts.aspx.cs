...
namespace report_end_of_week_tapouts
  ...
  public partial class TWebForm_report_end_of_week_tapouts: ki_web_ui.page_class
    {
    ...
    private void InitializeComponent()
      {
      PreRender += TWebForm_report_end_of_week_tapouts_PreRender;
      }
    ...
    protected override void OnInit(EventArgs e)
      ...
      if(
        ...
        Session.Add("mode:report/end-of-week-tapouts", k.EMPTY);
    ...
    private void TWebForm_report_end_of_week_tapouts_PreRender(object sender, System.EventArgs e)
      {
    ...
    protected override void Render(HtmlTextWriter writer)
      ...
      k.SmtpMailSend
        ...
        to:email_target,
        subject:"This week's tapouts, " + (p.agency_short_designator.Length > 0 ? p.agency_short_designator : "CITYWIDE"),
        message_string:body,
        be_html:true,
        cc:k.EMPTY,
        bcc:k.EMPTY,
    ...
    } // end TWebForm_report_end_of_week_tapouts
