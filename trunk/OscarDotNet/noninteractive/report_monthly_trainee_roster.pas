...
begin
  //
  Title.InnerText := ConfigurationSettings.AppSettings['application_name'] + ' - report_monthly_trainee_roster';
...
begin
  ...
  session.Add('mode:report/monthly-trainee-roster',system.string.EMPTY);
  //
