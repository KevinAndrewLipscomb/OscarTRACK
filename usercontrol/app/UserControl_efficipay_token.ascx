<%@ Control Language="c#" AutoEventWireup="True" Codebehind="UserControl_efficipay_token.ascx.cs" Inherits="UserControl_efficipay_token.TWebUserControl_efficipay_token"%>
...
<table cellspacing="0" cellpadding="5" width="100%" border="0">
  ...
  <tr>
    ...
    <td>
      <font class="">
        <ASP:TextBox id="TextBox_value" runat="server" columns="32" maxlength="32" cssclass="" enabled="False"></ASP:TextBox>
      </font>
    </td>
    <td nowrap="nowrap">
  ...
  <tr>
    <td><font class="">Time created:</font></td>
    <td>
      <font class="">
        <ASP:TextBox id="TextBox_time_created" runat="server"  cssclass="" enabled="False"></ASP:TextBox>
      </font>
    </td>
    <td nowrap="nowrap">
      &nbsp;</td>
  ...
  <tr>
    <td><font class="">Time retired:</font></td>
    <td>
      <font class="">
        <ASP:TextBox id="TextBox_time_retired" runat="server"  cssclass="" enabled="False"></ASP:TextBox>
      </font>
    </td>
    <td nowrap="nowrap">
    </td>
