...
{
    public partial class TWebForm_report_monthly_in_class_roster: ki_web_ui.page_class
    {
    private struct p_type
    {
        ...
        {
            string url;
            Title = Server.HtmlEncode(ConfigurationManager.AppSettings["application_name"]) + " - report_monthly_in_class_roster";
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            Session.Add("mode:report/monthly-emt-intern-roster", k.EMPTY);
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            // body
            // be_html
            k.SmtpMailSend(ConfigurationManager.AppSettings["sender_email_address"], p.biz_role_member_map.EmailTargetOf(p.role_name, p.agency_short_designator), "Report: Monthly Student Roster", body, true);
            Session.Abandon();
