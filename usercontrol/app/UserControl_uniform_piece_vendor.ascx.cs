...
#warning Revise the binder-related instance_id to this control appropriately.
        if (instance_id == "ASP.protected_overview_aspx.UserControl_member_binder_uniform_piece_vendor")
          {
#warning Revise the ClientID path to this control appropriately.
          p.be_loaded &= ((Session["UserControl_member_binder_PlaceHolder_content"] as string) == "UserControl_uniform_piece_vendor");
          }
...
//        }
        ...
        //
        p.be_loaded = false;
        p.be_ok_to_config_uniform_piece_vendors = k.Has((string[])(Session["privilege_array"]), "config-uniform_piece_vendors");
        p.id = k.EMPTY;
        p.summary = null;
        }
      }
    ...
    protected void Button_lookup_Click(object sender, System.EventArgs e)
      ...
      if (!PresentRecord(saved_id))
        ...
        p.biz_uniform_piece_vendors.Bind(saved_id, DropDownList_id);
