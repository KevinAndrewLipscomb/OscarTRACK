<%@ Control Language="c#" AutoEventWireup="True" Codebehind="UserControl_role_privilege_mapping.ascx.cs" Inherits="UserControl_role_privilege_mapping.TWebUserControl_role_privilege_mapping"%>
              ...
              <tr>
                <td valign="top">
                  <asp:GridView id="GridView_control" runat="server" gridlines="Horizontal" cellpadding="5" allowsorting="True" emptydatatext="No mappings" bordercolor="Gainsboro" borderstyle="Solid" borderwidth="1px" autogeneratecolumns="False">
                    ...
                    <Columns>
                      ...
                      <asp:BoundField datafield="role_name" headertext="Role" sortexpression="role_pecking_order%,privilege_name">
                        <HeaderStyle horizontalalign="Left"></HeaderStyle>
                        <ItemStyle horizontalalign="Left"></ItemStyle>
                      </asp:BoundField>
                      <asp:BoundField datafield="privilege_name" headertext="Privilege" sortexpression="privilege_name%,role_pecking_order">
                        <HeaderStyle horizontalalign="Left"></HeaderStyle>
                        <ItemStyle horizontalalign="Left"></ItemStyle>
                      </asp:BoundField>
                      <asp:BoundField datafield="privilege_id"></asp:BoundField>
                    </Columns>
                ...
                <td id="TableCell_add_mapping" runat="server" valign="top" visible="false">
                  <table cellspacing="0" cellpadding="2" border="0">
                    ...
                    <tr>
                      <td>
                        <asp:DropDownList id="DropDownList_privilege" runat="server" datatextfield="privilege_name" datavaluefield="privilege_id" font-size="Small" appenddatabounditems="True">
                          <asp:ListItem selected="True">-- Privilege --</asp:ListItem>
                        </asp:DropDownList>
                      </td>
                      <td><asp:RequiredFieldValidator id="RequiredFieldValidator_privilege" runat="server" errormessage="Please select a Privilege." font-bold="True" controltovalidate="DropDownList_privilege" setfocusonerror="True" display="Dynamic">!ERR!</asp:RequiredFieldValidator></td>
                    </tr>
                    <tr>
