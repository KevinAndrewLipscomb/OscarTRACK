<%@ Control Language="c#" AutoEventWireup="True" Codebehind="UserControl_tapout.ascx.cs" Inherits="UserControl_tapout.TWebUserControl_tapout"%>
...
<table cellspacing="0" cellpadding="5" width="100%" border="0">
  ...
  <tr>
    <td><font class="">Expected&nbsp;start:</font></td>
    <td>
      <font class="">
        <ASP:TextBox id="TextBox_expected_start" runat="server"  cssclass="" enabled="False"></ASP:TextBox>
      </font>
    </td>
    <td nowrap="nowrap">
      <ASP:RequiredFieldValidator id="RequiredFieldValidator_expected_start" runat="server" errormessage="Please enter Expected&nbsp;start." font-bold="True" controltovalidate="TextBox_expected_start">!ERR!</ASP:RequiredFieldValidator>
    </td>
  </tr>
  <tr>
  ...
  <tr>
    <td><font class="">Hours&nbsp;warning:</font></td>
    <td>
      <font class="">
        <ASP:TextBox id="TextBox_hours_warning" runat="server"  cssclass="" enabled="False"></ASP:TextBox>
      </font>
    </td>
    <td nowrap="nowrap">
      <ASP:RegularExpressionValidator id="RegularExpressionValidator_hours_warning" runat="server" errormessage="Please enter a valid Hours&nbsp;warning." font-bold="True" controltovalidate="TextBox_hours_warning" validationexpression="\d*">!ERR!</ASP:RegularExpressionValidator>
    </td>
  </tr>
  <tr>
    <td><font class="">Actor&nbsp;member&nbsp;id:</font></td>
    <td>
      <font class="">
        <ASP:TextBox id="TextBox_actor_member_id" runat="server"  cssclass="" enabled="False"></ASP:TextBox>
      </font>
    </td>
    <td nowrap="nowrap">
      <ASP:RequiredFieldValidator id="RequiredFieldValidator_actor_member_id" runat="server" errormessage="Please enter Actor&nbsp;member&nbsp;id." font-bold="True" controltovalidate="TextBox_actor_member_id">!ERR!</ASP:RequiredFieldValidator>
      <ASP:RegularExpressionValidator id="RegularExpressionValidator_actor_member_id" runat="server" errormessage="Please enter a valid Actor&nbsp;member&nbsp;id." font-bold="True" controltovalidate="TextBox_actor_member_id" validationexpression="\d*">!ERR!</ASP:RegularExpressionValidator>
    </td>
  </tr>
  <tr>
    <td><font class="">Actor&nbsp;timestamp:</font></td>
    <td>
      <font class="">
        <ASP:TextBox id="TextBox_actor_timestamp" runat="server"  cssclass="" enabled="False"></ASP:TextBox>
      </font>
    </td>
    <td nowrap="nowrap">
      <ASP:RequiredFieldValidator id="RequiredFieldValidator_actor_timestamp" runat="server" errormessage="Please enter Actor&nbsp;timestamp." font-bold="True" controltovalidate="TextBox_actor_timestamp">!ERR!</ASP:RequiredFieldValidator>
    </td>
  </tr>
      </table>
    </td>
