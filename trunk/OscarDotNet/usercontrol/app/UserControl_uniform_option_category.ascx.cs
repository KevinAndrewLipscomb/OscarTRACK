...
namespace UserControl_uniform_option_category
  {
  public partial class TWebUserControl_uniform_option_category: ki_web_ui.usercontrol_class
    {
    private struct p_type
      ...
      public bool be_ok_to_config_uniform_option_categories;
      public string id;
    ...
    protected void Page_Load(object sender, System.EventArgs e)
      ...
      if (!p.be_loaded)
        {
        LinkButton_new_record.Visible = p.be_ok_to_config_uniform_option_categories;
    ...
    private bool PresentRecord(string id)
      ...
      if
        (
        p.biz_uniform_option_categories.Get
          (
          id,
          out agency_id,
          out name
        ...
        SetDependentFieldAblements(p.be_ok_to_config_uniform_option_categories);
        Button_submit.Enabled = p.be_ok_to_config_uniform_option_categories;
        Button_delete.Enabled = p.be_ok_to_config_uniform_option_categories;
        result = true;
        }
      return result;
      }
    ...
    protected override void OnInit(System.EventArgs e)
      ...
      if (Session[instance_id + ".p"] != null)
        ...
        //
        if (instance_id == "ASP.protected_overview_aspx.UserControl_M_config_business_objects_binder_uniform_object_binder_uniform_option_category")
          {
          p.be_loaded &= ((Session["M_UserControl_config_UserControl_business_objects_binder_UserControl_uniform_object_binder_PlaceHolder_content"] as string) == "UserControl_uniform_option_category");
          }
//      else if (instance_id == "ASP.~_aspx.UserControl_~_binder_uniform_option_category")
//        {
//        p.be_loaded &= ((Session["UserControl_~_binder_PlaceHolder_content"] as string) == "UserControl_uniform_option_category");
//        }
        }
      else
        {
        ...
        //
        p.be_loaded = false;
        p.be_ok_to_config_uniform_option_categories = k.Has((string[])(Session["privilege_array"]), "config-uniforms");
        p.id = k.EMPTY;
        p.summary = null;
        }
      }
    ...
    public TWebUserControl_uniform_option_category Fresh()
      {
    ...
    protected void Button_submit_Click(object sender, System.EventArgs e)
      ...
      if (Page.IsValid)
        {
        p.biz_uniform_option_categories.Set
          (
    ...
    protected void Button_delete_Click(object sender, System.EventArgs e)
      {
      if (p.biz_uniform_option_categories.Delete(k.Safe(TextBox_id.Text, k.safe_hint_type.NUM)))
        {
        SetLookupMode();
        }
      else
    ...
    protected void Button_lookup_Click(object sender, System.EventArgs e)
      ...
      if (!PresentRecord(saved_id))
        ...
        p.biz_uniform_option_categories.Bind(saved_id, DropDownList_id);
    ...
    internal void SetP
      ...
      if (id.Length > 0)
        {
        p.id = id;
        p.summary = p.biz_uniform_option_categories.Summary(id);
        //p.be_ok_to_config_uniform_option_categories = p.biz_privileges.HasForAgency
        //  (
        //  member_id:p.biz_members.IdOfUserId(p.biz_user.IdNum()),
        //  privilege_name:"config-uniform_option_categories",
        //  agency_id:p.biz_uniform_option_categories.AgencyIdOf(p.summary)
        //  );
        p.presentation_mode = (p.be_ok_to_config_uniform_option_categories ? presentation_mode_enum.FULL_FUNCTION : p.presentation_mode = presentation_mode_enum.REVIEW_ONLY);
        }
      else
        {
        p.id = k.EMPTY;
    ...
    } // end TWebUserControl_uniform_option_category
