...
namespace report_monthly_current_roster
{
    public partial class TWebForm_report_monthly_current_roster: ki_web_ui.page_class
    {
    private struct p_type
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            Session.Add("mode:report/monthly-current-roster", k.EMPTY);
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            // body
            // be_html
            k.SmtpMailSend(ConfigurationManager.AppSettings["sender_email_address"], p.biz_role_member_map.EmailTargetOf(p.role_name, p.agency_short_designator), "Report: Monthly Current Roster", body, true);
            Session.Abandon();

        }

    } // end TWebForm_report_monthly_current_roster
