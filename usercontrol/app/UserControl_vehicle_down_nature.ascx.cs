...
namespace UserControl_vehicle_down_nature
  {
  public partial class TWebUserControl_vehicle_down_nature: ki_web_ui.usercontrol_class
    {
    private p_type p;
    ...
    protected void Page_Load(object sender, System.EventArgs e)
      ...
      if (!p.be_loaded)
        {
        LinkButton_new_record.Visible = p.be_ok_to_config_vehicle_down_natures;
        LinkButton_go_to_match_first.Text = k.ExpandTildePath(LinkButton_go_to_match_first.Text);
        LinkButton_go_to_match_prior.Text = k.ExpandTildePath(LinkButton_go_to_match_prior.Text);
        LinkButton_go_to_match_next.Text = k.ExpandTildePath(LinkButton_go_to_match_next.Text);
        LinkButton_go_to_match_last.Text = k.ExpandTildePath(LinkButton_go_to_match_last.Text);
        RequireConfirmation(Button_delete, "Are you sure you want to delete this record?");
        if ((Session["mode:goto"] != null) && Session["mode:goto"].ToString().Contains("/vehicle_down_nature/"))
          {
    ...
    private bool PresentRecord(string id)
      ...
      if
        (
        p.biz_vehicle_down_natures.Get
          (
          id,
          out name,
          out pecking_order,
        ...
        CheckBox_be_failure.Checked = be_failure;
        TextBox_elaboration.Text = elaboration;
        Button_lookup.Enabled = false;
        Label_lookup_arrow.Enabled = false;
        Label_lookup_hint.Enabled = false;
        LinkButton_reset.Enabled = true;
        SetDependentFieldAblements(p.be_ok_to_config_vehicle_down_natures);
        Button_submit.Enabled = p.be_ok_to_config_vehicle_down_natures;
        Button_delete.Enabled = p.be_ok_to_config_vehicle_down_natures;
        result = true;
        }
      return result;
      }
    ...
    protected override void OnInit(System.EventArgs e)
      ...
      if (Session["UserControl_vehicle_down_nature.p"] != null)
        ...
        p.be_ok_to_config_vehicle_down_natures = k.Has((string[])(Session["privilege_array"]), "config-vehicle_down_natures");
        }
      }
    ...
    protected void Button_submit_Click(object sender, System.EventArgs e)
      ...
      if (Page.IsValid)
        {
        p.biz_vehicle_down_natures.Set
          (
    ...
    protected void Button_delete_Click(object sender, System.EventArgs e)
      {
      if (p.biz_vehicle_down_natures.Delete(k.Safe(TextBox_id.Text, k.safe_hint_type.ALPHANUM)))
        {
        SetLookupMode();
        }
      else
    ...
    private void SetDependentFieldAblements(bool ablement)
      ...
      CheckBox_be_failure.Enabled = ablement;
    ...
    protected void Button_lookup_Click(object sender, System.EventArgs e)
      ...
      if (!PresentRecord(saved_id))
        ...
        p.biz_vehicle_down_natures.Bind(saved_id, DropDownList_id);
