<%@ Control Language="c#" AutoEventWireup="True" Codebehind="UserControl_uniform_issuance.ascx.cs" Inherits="UserControl_uniform_issuance.TWebUserControl_uniform_issuance"%>
...
<table cellspacing="0" cellpadding="5" width="100%" border="0">
  ...
  <tr>
    <td><font class="">Date:</font></td>
    <td>
      <font class="">
        <uc1:UserControl_drop_down_date id="UserControl_drop_down_date_date" runat="server"  cssclass=""></uc1:UserControl_drop_down_date>
      </font>
    </td>
    <td nowrap="nowrap">
    </td>
  ...
  <tr>
    <td><font class="">Catalog&nbsp;id:</font></td>
    <td>
      <font class="">
        <ASP:TextBox id="TextBox_catalog_id" runat="server"  cssclass="" enabled="False"></ASP:TextBox>
      </font>
    </td>
    <td nowrap="nowrap">
      <ASP:RequiredFieldValidator id="RequiredFieldValidator_catalog_id" runat="server" errormessage="Please enter Catalog&nbsp;id." font-bold="True" controltovalidate="TextBox_catalog_id">!ERR!</ASP:RequiredFieldValidator>
      <ASP:RegularExpressionValidator id="RegularExpressionValidator_catalog_id" runat="server" errormessage="Please enter a valid Catalog&nbsp;id." font-bold="True" controltovalidate="TextBox_catalog_id" validationexpression="-?\d+">!ERR!</ASP:RegularExpressionValidator>
    </td>
  </tr>
      </table>
    </td>
