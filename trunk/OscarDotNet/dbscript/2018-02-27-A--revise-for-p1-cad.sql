...
;
ALTER TABLE `cad_record` CHANGE COLUMN `incident_num` `incident_num` CHAR(13) NULL DEFAULT NULL
;
ALTER TABLE `field_situation` CHANGE COLUMN `case_num` `case_num` CHAR(13) NOT NULL
;
