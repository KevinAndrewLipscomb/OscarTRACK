...
<%@ Page language="c#" Debug="true" Codebehind="donation_log.aspx.cs" AutoEventWireup="True" Inherits="donation_log.TWebForm_donation_log" %>
...
<%@ Register src="../usercontrol/app/UserControl_donation_log.ascx" tagname="UserControl_donation_log" tagprefix="uc2" %>
<html>
  <head runat="server">
    <title/>
    <!-- $Id$ -->
