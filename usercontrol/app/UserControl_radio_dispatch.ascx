<%@ Control Language="c#" AutoEventWireup="True" Codebehind="UserControl_radio_dispatch.ascx.cs" Inherits="UserControl_radio_dispatch.TWebUserControl_radio_dispatch"%>
...
<table cellspacing="0" cellpadding="5" width="100%" border="0">
  ...
  <tr>
    <td><font class="">Capcode:</font></td>
    <td>
      <font class="">
        <ASP:TextBox id="TextBox_capcode" runat="server" columns="7" maxlength="7" cssclass="" enabled="False"></ASP:TextBox>
      </font>
    </td>
    <td nowrap="nowrap">
  ...
  <tr>
    <td><font class="">Transmission&nbsp;datetime:</font></td>
    <td>
      <font class="">
        <ASP:TextBox id="TextBox_transmission_datetime" runat="server"  cssclass="" enabled="False"></ASP:TextBox>
      </font>
    </td>
    <td nowrap="nowrap">
      <ASP:RequiredFieldValidator id="RequiredFieldValidator_transmission_datetime" runat="server" errormessage="Please enter Transmission&nbsp;datetime." font-bold="True" controltovalidate="TextBox_transmission_datetime">!ERR!</ASP:RequiredFieldValidator>
    </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td nowrap="nowrap">
      <ASP:RequiredFieldValidator id="RequiredFieldValidator_nature" runat="server" errormessage="Please enter Nature." font-bold="True" controltovalidate="TextBox_nature">!ERR!</ASP:RequiredFieldValidator>
    </td>
  </tr>
      </table>
    </td>
