<%@ Control Language="c#" AutoEventWireup="True" Codebehind="UserControl_care_skill_rating.ascx.cs" Inherits="UserControl_care_skill_rating.TWebUserControl_care_skill_rating"%>
...
<table cellspacing="0" cellpadding="5" width="100%" border="0">
  ...
  <tr>
    <td><font class="">Care&nbsp;skill&nbsp;id:</font></td>
    <td>
      <font class="">
        <ASP:TextBox id="TextBox_care_skill_id" runat="server"  cssclass="" enabled="False"></ASP:TextBox>
      </font>
    </td>
    <td nowrap="True">
      <ASP:RequiredFieldValidator id="RequiredFieldValidator_care_skill_id" runat="server" errormessage="Please enter Care&nbsp;skill&nbsp;id." font-bold="True" controltovalidate="TextBox_care_skill_id">!ERR!</ASP:RequiredFieldValidator>
      <ASP:RegularExpressionValidator id="RegularExpressionValidator_care_skill_id" runat="server" errormessage="Please enter a valid Care&nbsp;skill&nbsp;id." font-bold="True" controltovalidate="TextBox_care_skill_id" validationexpression="-?\d+">!ERR!</ASP:RegularExpressionValidator>
    </td>
  </tr>
  <tr>
    <td><font class="">Skill&nbsp;rating&nbsp;id:</font></td>
    <td>
      <font class="">
        <ASP:TextBox id="TextBox_skill_rating_id" runat="server"  cssclass="" enabled="False"></ASP:TextBox>
      </font>
    </td>
    <td nowrap="True">
      <ASP:RegularExpressionValidator id="RegularExpressionValidator_skill_rating_id" runat="server" errormessage="Please enter a valid Skill&nbsp;rating&nbsp;id." font-bold="True" controltovalidate="TextBox_skill_rating_id" validationexpression="-?\d+">!ERR!</ASP:RegularExpressionValidator>
    </td>
  </tr>
  <tr>
    <td><font class="">Patient&nbsp;encounter&nbsp;id:</font></td>
    <td>
      <font class="">
        <ASP:TextBox id="TextBox_patient_encounter_id" runat="server"  cssclass="" enabled="False"></ASP:TextBox>
      </font>
    </td>
    <td nowrap="True">
      <ASP:RequiredFieldValidator id="RequiredFieldValidator_patient_encounter_id" runat="server" errormessage="Please enter Patient&nbsp;encounter&nbsp;id." font-bold="True" controltovalidate="TextBox_patient_encounter_id">!ERR!</ASP:RequiredFieldValidator>
      <ASP:RegularExpressionValidator id="RegularExpressionValidator_patient_encounter_id" runat="server" errormessage="Please enter a valid Patient&nbsp;encounter&nbsp;id." font-bold="True" controltovalidate="TextBox_patient_encounter_id" validationexpression="-?\d+">!ERR!</ASP:RegularExpressionValidator>
    </td>
  </tr>
      </table>
    </td>
