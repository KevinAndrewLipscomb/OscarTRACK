using Class_biz_ems_systems;
using kix;
using System;
using System.Web.UI;
using System.Web.UI.WebControls;

namespace UserControl_ems_system
{
    ...
    public partial class TWebUserControl_ems_system: ki_web_ui.usercontrol_class
    {
      ...
      LinkButton_go_to_match_first.Visible = false;
        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            if (!p.be_loaded)
            {
                LinkButton_new_record.Visible = p.be_ok_to_config_ems_systems;
        ...
        Literal_match_index.Text = DropDownList_code.SelectedIndex.ToString();
            ...
            string description;
            result = false;
            if (p.biz_ems_systems.Get(id, out description))
            {
                TextBox_id.Text = id;
                ...
                SetDependentFieldAblements(p.be_ok_to_config_ems_systems);
                Button_submit.Enabled = p.be_ok_to_config_ems_systems;
                Button_delete.Enabled = p.be_ok_to_config_ems_systems;
                result = true;
            }
            return result;
        }
        ...
        private void SetLookupMode()
        {
            ...
            LinkButton_new_record.Enabled = p.be_ok_to_config_ems_systems;
            TextBox_id.Focus();
        }
        ...
        protected override void OnInit(System.EventArgs e)
        {
            ...
            if (Session[InstanceId() + ".p"] != null)
            {
                ...
                p.be_loaded = IsPostBack && ((Session["UserControl_member_binder_UserControl_config_UserControl_business_objects_binder_PlaceHolder_content"] as string) == "UserControl_ems_system");
            }
            else
            {
                p.be_loaded = false;
                p.biz_ems_systems = new TClass_biz_ems_systems();
                p.be_ok_to_config_ems_systems = k.Has((string[])(Session["privilege_array"]), "config-ems_systems");
            }
        ...
        public TWebUserControl_ems_system Fresh()
        {
            TWebUserControl_ems_system result;
        ...
        protected void Button_submit_Click(object sender, System.EventArgs e)
        {
            if (Page.IsValid)
            {
                p.biz_ems_systems.Set(k.Safe(TextBox_id.Text, k.safe_hint_type.NUM), k.Safe(TextBox_description.Text, k.safe_hint_type.PUNCTUATED));
        ...
        {
            if (p.biz_ems_systems.Delete(k.Safe(TextBox_id.Text, k.safe_hint_type.ALPHANUM)))
            {
                SetLookupMode();
            }
            else
        ...
        protected void Button_lookup_Click(object sender, System.EventArgs e)
        {
            ...
            if (!PresentRecord(saved_id))
            {
                ...
                p.biz_ems_systems.Bind(saved_id, DropDownList_code);
