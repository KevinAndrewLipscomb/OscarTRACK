...
namespace UserControl_custom_model
  {
  public partial class TWebUserControl_custom_model: ki_web_ui.usercontrol_class
    {
    private struct p_type
      ...
      public bool be_ok_to_config_custom_models;
      }
    ...
    protected void Page_Load(object sender, System.EventArgs e)
      ...
      if (!p.be_loaded)
        {
        p.biz_custom_makes.BindDirectToListControl(DropDownList_make);
        DropDownList_make.Items.Insert(0,(new ListItem("-- make --",k.EMPTY)));
        LinkButton_new_record.Visible = p.be_ok_to_config_custom_models;
        LinkButton_go_to_match_first.Text = k.ExpandTildePath(LinkButton_go_to_match_first.Text);
        LinkButton_go_to_match_prior.Text = k.ExpandTildePath(LinkButton_go_to_match_prior.Text);
        LinkButton_go_to_match_next.Text = k.ExpandTildePath(LinkButton_go_to_match_next.Text);
        LinkButton_go_to_match_last.Text = k.ExpandTildePath(LinkButton_go_to_match_last.Text);
        RequireConfirmation(Button_delete, "Are you sure you want to delete this record?");
        if ((Session["mode:goto"] != null) && Session["mode:goto"].ToString().Contains("/custom_model/"))
          {
    ...
    private bool PresentRecord(string id)
      ...
      if
        ...
        SetDependentFieldAblements(p.be_ok_to_config_custom_models);
        Button_submit.Enabled = p.be_ok_to_config_custom_models;
        Button_delete.Enabled = p.be_ok_to_config_custom_models;
        result = true;
        }
      return result;
      }
    ...
    protected override void OnInit(System.EventArgs e)
      ...
      if (Session["UserControl_custom_model.p"] != null)
        ...
        p.be_ok_to_config_custom_models = k.Has((string[])(Session["privilege_array"]), "config-fleet-attributes");
        }
      }
    ...
    private void InitializeComponent()
      ...
      this.PreRender += this.TWebUserControl_custom_model_PreRender;
      }

    private void TWebUserControl_custom_model_PreRender(object sender, System.EventArgs e)
      {
      SessionSet("UserControl_custom_model.p", p);
      }

    public TWebUserControl_custom_model Fresh()
      {
      Session.Remove("UserControl_custom_model.p");
      return this;
      }
    ...
    protected void Button_delete_Click(object sender, System.EventArgs e)
      {
      if (p.biz_custom_models.Delete(k.Safe(TextBox_id.Text, k.safe_hint_type.NUM)))
        {
        SetLookupMode();
        }
      else
    ...
    protected void Button_lookup_Click(object sender, System.EventArgs e)
      ...
      if (!PresentRecord(saved_id))
        ...
        p.biz_custom_models.Bind(saved_id, DropDownList_id);
    ...
    } // end TWebUserControl_custom_model
