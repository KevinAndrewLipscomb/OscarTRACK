...
namespace UserControl_efficipay_token
  {
  public partial class TWebUserControl_efficipay_token: ki_web_ui.usercontrol_class
    {
    private p_type p;
    ...
    private void Clear()
      ...
      TextBox_time_created.Text = k.EMPTY;
      TextBox_time_retired.Text = k.EMPTY;
    ...
    protected void Page_Load(object sender, System.EventArgs e)
      ...
      if (!p.be_loaded)
        {
        LinkButton_new_record.Visible = p.be_ok_to_config_efficipay_tokens;
        LinkButton_go_to_match_first.Text = k.ExpandTildePath(LinkButton_go_to_match_first.Text);
        LinkButton_go_to_match_prior.Text = k.ExpandTildePath(LinkButton_go_to_match_prior.Text);
        LinkButton_go_to_match_next.Text = k.ExpandTildePath(LinkButton_go_to_match_next.Text);
        LinkButton_go_to_match_last.Text = k.ExpandTildePath(LinkButton_go_to_match_last.Text);
        if ((Session["mode:goto"] != null) && Session["mode:goto"].ToString().Contains("/efficipay_token/"))
          {
    ...
    private bool PresentRecord(string id)
      ...
      DateTime time_retired;
      result = false;
      if
        (
        p.biz_efficipay_tokens.Get
          (
          id,
          out value,
          out time_created,
        ...
        TextBox_time_created.Text = time_created.ToString("yyyy-MM-dd HH:mm:ss");
        TextBox_time_retired.Text = (time_retired == DateTime.MaxValue ? k.EMPTY : time_retired.ToString("yyyy-MM-dd HH:mm:ss"));
        Button_lookup.Enabled = false;
        Label_lookup_arrow.Enabled = false;
        Label_lookup_hint.Enabled = false;
        LinkButton_reset.Enabled = true;
        SetDependentFieldAblements(p.be_ok_to_config_efficipay_tokens);
        Button_submit.Enabled = p.be_ok_to_config_efficipay_tokens;
        result = true;
        }
      return result;
      }
    ...
    protected override void OnInit(System.EventArgs e)
      ...
      if (Session[InstanceId() + ".p"] != null)
        ...
        p.be_loaded = IsPostBack && ((Session["M_UserControl_config_PlaceHolder_content"] as string) == "UserControl_efficipay_token");
        }
      else
        {
        p.be_loaded = false;
        ...
        p.be_ok_to_config_efficipay_tokens = k.Has((string[])(Session["privilege_array"]), "config-efficipay-tokens");
        }
      }
    ...
    private void InitializeComponent()
      ...
      this.PreRender += this.TWebUserControl_efficipay_token_PreRender;
      }

    private void TWebUserControl_efficipay_token_PreRender(object sender, System.EventArgs e)
      {
      SessionSet(InstanceId() + ".p", p);
      }

    public TWebUserControl_efficipay_token Fresh()
      {
    ...
    protected void Button_submit_Click(object sender, System.EventArgs e)
      ...
      if (Page.IsValid)
        {
        p.biz_efficipay_tokens.Set
          (
          k.Safe(TextBox_id.Text,k.safe_hint_type.NUM),
          k.Safe(TextBox_value.Text,k.safe_hint_type.ALPHANUM).Trim(),
          DateTime.Now
          );
    ...
    protected void Button_delete_Click(object sender, System.EventArgs e)
      {
      if (p.biz_efficipay_tokens.Delete(k.Safe(TextBox_id.Text, k.safe_hint_type.ALPHANUM)))
        {
        SetLookupMode();
        }
      else
    ...
    protected void Button_lookup_Click(object sender, System.EventArgs e)
      ...
      if (!PresentRecord(saved_id))
        ...
        p.biz_efficipay_tokens.Bind(saved_id, DropDownList_id);
    ...
    private struct p_type
      ...
      public bool be_ok_to_config_efficipay_tokens;
      } // end p_type

    } // end TWebUserControl_efficipay_token
