...
namespace UserControl_agency_satellite_station
  {
  public partial class TWebUserControl_agency_satellite_station: ki_web_ui.usercontrol_class
    {
    private struct p_type
      {
      public bool be_loaded;
      public TClass_biz_agencies biz_agencies;
      public TClass_biz_agency_satellite_stations biz_agency_satellite_stations;
    ...
    protected void Page_Load(object sender, System.EventArgs e)
      ...
      if (!p.be_loaded)
        {
        LinkButton_new_record.Visible = p.be_ok_to_config_agency_satellite_stations;
        ...
        p.biz_agencies.BindListControlShortDashLongSatelliteStations(DropDownList_satellite_station);
        //
        RequireConfirmation(Button_delete, "Are you sure you want to delete this record?");
        if ((Session["mode:goto"] != null) && Session["mode:goto"].ToString().Contains("/agency_satellite_station/"))
          {
    ...
    private bool PresentRecord(string id)
      ...
      if
        (
        p.biz_agency_satellite_stations.Get
          (
          id,
          out agency_id,
        ...
        SetDependentFieldAblements(p.be_ok_to_config_agency_satellite_stations);
        Button_submit.Enabled = p.be_ok_to_config_agency_satellite_stations;
        Button_delete.Enabled = p.be_ok_to_config_agency_satellite_stations;
        result = true;
        }
      return result;
      }
    ...
    protected override void OnInit(System.EventArgs e)
      ...
      if (Session["UserControl_agency_satellite_station.p"] != null)
        ...
        p.biz_agency_satellite_stations = new TClass_biz_agency_satellite_stations();
        p.biz_role_member_map = new TClass_biz_role_member_map();
        //
        p.be_loaded = false;
        p.be_ok_to_config_agency_satellite_stations = k.Has((string[])(Session["privilege_array"]), "config-agencies");
        }
      }
    ...
    protected void Button_submit_Click(object sender, System.EventArgs e)
      ...
      if (Page.IsValid)
        {
        p.biz_agency_satellite_stations.Set
          (
          k.Safe(TextBox_id.Text,k.safe_hint_type.NUM),
          k.Safe(DropDownList_agency.SelectedValue,k.safe_hint_type.NUM),
          k.Safe(DropDownList_satellite_station.SelectedValue,k.safe_hint_type.NUM)
          );
    ...
    protected void Button_delete_Click(object sender, System.EventArgs e)
      {
      if (p.biz_agency_satellite_stations.Delete(k.Safe(TextBox_id.Text, k.safe_hint_type.ALPHANUM)))
        {
        SetLookupMode();
        }
      else
    ...
    private void SetDependentFieldAblements(bool ablement)
      ...
      DropDownList_satellite_station.Enabled = ablement;
      }
    ...
    protected void Button_lookup_Click(object sender, System.EventArgs e)
      ...
      if (!PresentRecord(saved_id))
        ...
        p.biz_agency_satellite_stations.Bind(saved_id, DropDownList_id);
    ...
    } // end TWebUserControl_agency_satellite_station
