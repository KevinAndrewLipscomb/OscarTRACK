...
namespace UserControl_driver_skill_rating
  {
  public partial class TWebUserControl_driver_skill_rating: ki_web_ui.usercontrol_class
    {
    ...
    private void Clear()
      ...
      TextBox_driver_skill_id.Text = k.EMPTY;
      TextBox_skill_rating_id.Text = k.EMPTY;
      TextBox_eval_id.Text = k.EMPTY;
    ...
    protected void Page_Load(object sender, System.EventArgs e)
      ...
      if (!p.be_loaded)
        {
        LinkButton_new_record.Visible = p.be_ok_to_config_driver_skill_ratings;
        ...
        SetDataEntryMode();
        if ((Session["mode:goto"] != null) && Session["mode:goto"].ToString().Contains("/driver_skill_rating/"))
          {
    ...
    private bool PresentRecord(string id)
      ...
      if
        (
        p.biz_driver_skill_ratings.Get
          (
          id,
          out driver_skill_id,
          out skill_rating_id,
        ...
        TextBox_driver_skill_id.Text = driver_skill_id;
        TextBox_skill_rating_id.Text = skill_rating_id;
        TextBox_eval_id.Text = eval_id;
        Button_lookup.Enabled = false;
        Label_lookup_arrow.Enabled = false;
        Label_lookup_hint.Enabled = false;
        LinkButton_reset.Enabled = true;
        SetDependentFieldAblements(p.be_ok_to_config_driver_skill_ratings);
        Button_submit.Enabled = p.be_ok_to_config_driver_skill_ratings;
        Button_delete.Enabled = p.be_ok_to_config_driver_skill_ratings;
        result = true;
        }
      return result;
      }
    ...
    protected override void OnInit(System.EventArgs e)
      ...
      if (Session[InstanceId() + ".p"] != null)
        ...
        p.be_loaded = IsPostBack && ((Session["UserControl_member_binder_PlaceHolder_content"] as string) == "UserControl_driver_skill_rating");
        }
      else
        {
        p.be_loaded = false;
        ...
        p.be_ok_to_config_driver_skill_ratings = k.Has((string[])(Session["privilege_array"]), "config-driver_skill_ratings");
        }
      }
    ...
    public TWebUserControl_driver_skill_rating Fresh()
      {
    ...
    protected void Button_delete_Click(object sender, System.EventArgs e)
      {
      if (p.biz_driver_skill_ratings.Delete(k.Safe(TextBox_id.Text, k.safe_hint_type.NUM)))
        {
        SetLookupMode();
        }
      else
    ...
    private void SetDependentFieldAblements(bool ablement)
      {
      TextBox_driver_skill_id.Enabled = ablement;
      TextBox_skill_rating_id.Enabled = ablement;
      TextBox_eval_id.Enabled = ablement;
      }
    ...
    protected void Button_lookup_Click(object sender, System.EventArgs e)
      ...
      if (!PresentRecord(saved_id))
        ...
        p.biz_driver_skill_ratings.Bind(saved_id, DropDownList_id);
    ...
    } // end TWebUserControl_driver_skill_rating
